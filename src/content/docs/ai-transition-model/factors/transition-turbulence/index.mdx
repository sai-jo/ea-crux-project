...
description: "The degree of disruption during the AI transition—economic displacement, political instability, social fragmentation, and institutional stress that affects both existential catastrophe and long-term trajectory."
sidebar:
  label: Overview
  order: 0
lastEdited: "2026-01-03"
---
import {Mermaid, DataInfoBox} from '../../../../../components/wiki';
...
|-----------|-----------|--------|
| [Racing Intensity](/ai-transition-model/parameters/racing-intensity/) | High → More turbulence | Faster change, less time to adapt |
| [Societal Resilience](/ai-transition-model/parameters/societal-resilience/) | Low → More turbulence | Less capacity to absorb shocks |
| [Economic Stability](/ai-transition-model/parameters/economic-stability/) | Low → More turbulence | Economic disruption cascades |
| [Regulatory Capacity](/ai-transition-model/parameters/regulatory-capacity/) | Low → More turbulence | Governance can't keep pace |
| [International Coordination](/ai-transition-model/parameters/international-coordination/) | Low → More turbulence | No coordinated response |
| [Societal Trust](/ai-transition-model/parameters/societal-trust/) | Low → More turbulence | Social cohesion breaks down |

...
---
import {Backlinks, DataInfoBox, FactorRelationshipDiagram, ImpactList, PageCauseEffectGraph} from '../../../../components/wiki';
...
<PageCauseEffectGraph slug="existential-catastrophe" client:load />

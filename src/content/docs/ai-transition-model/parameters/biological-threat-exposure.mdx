...
### Related Parameters
- [Cyber Threat Exposure](/ai-transition-model/parameters/cyber-threat-exposure/) — Parallel analysis of digital security offense-defense balance
- [Societal Resilience](/ai-transition-model/parameters/societal-resilience/) — Society's broader capacity to recover from catastrophic shocks
- [International Coordination](/ai-transition-model/parameters/international-coordination/) — Global governance affecting biosecurity treaties and information sharing
...
<PageCauseEffectGraph slug="biological-threat-exposure" client:load />

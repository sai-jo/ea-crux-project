...
### Related Parameters
- [Human Agency](/ai-transition-model/parameters/human-agency/) — Economic security enables meaningful choice
- [Societal Trust](/ai-transition-model/parameters/societal-trust/) — Economic disruption erodes trust in institutions
- [AI Control Concentration](/ai-transition-model/parameters/ai-control-concentration/) — Capital-labor imbalance concentrates power
...
<PageCauseEffectGraph slug="economic-stability" client:load />

...
uncertainty: 55
---
import {DataInfoBox, Backlinks, R, Mermaid, ParameterDistinctions, PageCauseEffectGraph} from '../../../../components/wiki';
...
Epistemic health depends on institutional trust. Key indicators: mass media trust at historic low (28%), 59% globally worried about distinguishing real from fake. **See [Reality Coherence](/ai-transition-model/parameters/reality-coherence/) for detailed institutional trust data.**
...
### Related Parameters
- [Societal Trust](/ai-transition-model/parameters/societal-trust/) — Broader parameter encompassing institutional and interpersonal trust
- [Information Authenticity](/ai-transition-model/parameters/information-authenticity/) — Technical capacity to verify content provenance
- [Reality Coherence](/ai-transition-model/parameters/reality-coherence/) — Degree of shared understanding of fundamental reality
- [Human Agency](/ai-transition-model/parameters/human-agency/) — Human capacity for autonomous decision-making (requires epistemic foundation)
- [Institutional Quality](/ai-transition-model/parameters/institutional-quality/) — Institutional capacity depends on epistemic commons
- [Regulatory Capacity](/ai-transition-model/parameters/regulatory-capacity/) — Effective regulation requires accurate information assessment
...
<PageCauseEffectGraph slug="epistemic-health" client:load />

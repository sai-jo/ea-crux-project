...
**Contributes to:** [Societal Adaptability](/ai-transition-model/parameters/adaptability/), [Epistemic Foundation](/ai-transition-model/parameters/epistemics/)
...
### Related Parameters
- [Preference Authenticity](/ai-transition-model/parameters/preference-authenticity/) — Whether preferences are genuine
- [Epistemic Health](/ai-transition-model/parameters/epistemic-health/) — Ability to form accurate beliefs
- [Human Oversight Quality](/ai-transition-model/parameters/human-oversight-quality/) — Effectiveness of human review
- [Human Expertise](/ai-transition-model/parameters/human-expertise/) — Skill maintenance
- [Societal Trust](/ai-transition-model/parameters/societal-trust/) — Trust in institutions enabling agency
- [AI Control Concentration](/ai-transition-model/parameters/ai-control-concentration/) — Who holds decision-making power
- [Regulatory Capacity](/ai-transition-model/parameters/regulatory-capacity/) — Government ability to protect agency
- [Information Authenticity](/ai-transition-model/parameters/information-authenticity/) — Can verify information for informed choice
...
<PageCauseEffectGraph slug="human-agency" client:load />

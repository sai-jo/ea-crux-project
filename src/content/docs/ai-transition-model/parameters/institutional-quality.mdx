...
### Related Parameters
- [Regulatory Capacity](/ai-transition-model/parameters/regulatory-capacity/) — Capacity enables quality; quality without capacity is insufficient
- [International Coordination](/ai-transition-model/parameters/international-coordination/) — International frameworks can reinforce domestic quality
- [Safety Culture Strength](/ai-transition-model/parameters/safety-culture-strength/) — Internal institutional culture affects resistance to capture
- [Epistemic Health](/ai-transition-model/parameters/epistemic-health/) — Ability to evaluate complex AI claims affects institutional independence
- [Societal Trust](/ai-transition-model/parameters/societal-trust/) — Public trust enables institutional legitimacy
- [Human Agency](/ai-transition-model/parameters/human-agency/) — Institutional quality affects ability to maintain human control
...
<PageCauseEffectGraph slug="institutional-quality" client:load />

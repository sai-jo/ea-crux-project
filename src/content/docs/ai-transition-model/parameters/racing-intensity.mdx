...
**Contributes to:** [Governance Capacity](/ai-transition-model/parameters/governance/) (inverse), [Misuse Potential](/ai-transition-model/factors/misuse-potential/)
...
### Related Parameters
- [Safety Culture Strength](/ai-transition-model/parameters/safety-culture-strength/) — Internal safety prioritization that resists racing pressure
- [Coordination Capacity](/ai-transition-model/parameters/coordination-capacity/) — Industry cooperation that reduces competitive intensity
- [International Coordination](/ai-transition-model/parameters/international-coordination/) — Geopolitical cooperation level
- [Regulatory Capacity](/ai-transition-model/parameters/regulatory-capacity/) — Government ability to moderate racing through policy
- [Safety-Capability Gap](/ai-transition-model/parameters/safety-capability-gap/) — The gap that racing widens
- [AI Control Concentration](/ai-transition-model/parameters/ai-control-concentration/) — Concentration dynamics from racing outcomes
...
<PageCauseEffectGraph slug="racing-intensity" client:load />

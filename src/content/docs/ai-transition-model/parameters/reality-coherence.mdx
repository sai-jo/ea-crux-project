...
### Related Parameters
- [Epistemic Health](/ai-transition-model/parameters/epistemic-health/) — Individual and collective ability to distinguish truth from falsehood
- [Societal Trust](/ai-transition-model/parameters/societal-trust/) — Confidence in institutions enabling collective action
- [Information Authenticity](/ai-transition-model/parameters/information-authenticity/) — Degree to which content sources are verifiable and genuine
- [Human Agency](/ai-transition-model/parameters/human-agency/) — Capacity for autonomous decision-making (requires shared reality)
- [Institutional Quality](/ai-transition-model/parameters/institutional-quality/) — Effectiveness of democratic governance structures
- [International Coordination](/ai-transition-model/parameters/international-coordination/) — Cross-border cooperation (depends on shared threat assessment)
...
<PageCauseEffectGraph slug="reality-coherence" client:load />

...
### Related Parameters
- [International Coordination](/ai-transition-model/parameters/international-coordination/) — Capacity enables effective international engagement
- [Institutional Quality](/ai-transition-model/parameters/institutional-quality/) — Broader health of governance institutions
- [Safety Culture Strength](/ai-transition-model/parameters/safety-culture-strength/) — Industry norms that complement or substitute for regulation
- [Epistemic Health](/ai-transition-model/parameters/epistemic-health/) — Societal ability to distinguish truth from falsehood—prerequisite for evidence-based regulation
...
<PageCauseEffectGraph slug="regulatory-capacity" client:load />

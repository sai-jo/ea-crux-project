...
### Related Parameters
- [Cyber Threat Exposure](/ai-transition-model/parameters/cyber-threat-exposure/) — Defense against attacks
- [Biological Threat Exposure](/ai-transition-model/parameters/biological-threat-exposure/) — Biological defense
- [Economic Stability](/ai-transition-model/parameters/economic-stability/) — Economic resilience
- [Human Expertise](/ai-transition-model/parameters/human-expertise/) — Skill maintenance
...
<PageCauseEffectGraph slug="societal-resilience" client:load />

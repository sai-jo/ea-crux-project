...
- [Steady State](/knowledge-base/parameters/outcomes/steady-state/) ↓↓↓ — Clear thinking preserves human autonomy and genuine agency
- [Transition Smoothness](/knowledge-base/parameters/outcomes/transition-smoothness/) ↓↓ — Epistemic health enables coordination during rapid change
...
Epistemic health depends on institutional trust. Key indicators: mass media trust at historic low (28%), 59% globally worried about distinguishing real from fake. **See [Reality Coherence](/knowledge-base/parameters/reality-coherence/) for detailed institutional trust data.**

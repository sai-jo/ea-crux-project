...
**Contributes to:** [Societal Adaptability](/knowledge-base/parameters/aggregates/societal-adaptability/), [Epistemic Foundation](/knowledge-base/parameters/aggregates/epistemic-foundation/)

**Primary outcomes affected:**
- [Steady State](/knowledge-base/parameters/outcomes/steady-state/) ↓↓ — Agency is essential for human autonomy in the long term
- [Transition Smoothness](/knowledge-base/parameters/outcomes/transition-smoothness/) ↓ — Empowered people can adapt to changing conditions

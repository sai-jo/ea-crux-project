...
- [Transition Smoothness](/knowledge-base/parameters/outcomes/transition-smoothness/) ↓↓ — Expertise enables people to adapt to changing conditions
- [Acute Risk](/knowledge-base/parameters/outcomes/acute-risk/) ↓ — Human expertise enables meaningful oversight of AI systems

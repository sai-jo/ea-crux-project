...
- [Transition Smoothness](/knowledge-base/ai-transition-model/factors/transition-turbulence/) ↓↓ — Expertise enables people to adapt to changing conditions
- [Acute Risk](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) ↓ — Human expertise enables meaningful oversight of AI systems
...
### Related Parameters
- [Human Agency](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/) — Expertise enables meaningful choice and self-determination
- [Human Oversight Quality](/knowledge-base/ai-transition-model/factors/misalignment-potential/human-oversight-quality/) — Expertise is the foundation of effective AI oversight
- [Epistemic Health](/knowledge-base/ai-transition-model/factors/civilizational-competence/epistemic-health/) — Collective knowledge maintenance systems
- [Societal Trust](/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-trust/) — Expertise decline erodes institutional and epistemic trust

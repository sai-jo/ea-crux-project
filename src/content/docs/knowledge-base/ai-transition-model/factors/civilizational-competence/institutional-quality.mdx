...
- [Steady State](/knowledge-base/parameters/outcomes/steady-state/) ↓↓ — Quality institutions preserve democratic governance in the long term
- [Transition Smoothness](/knowledge-base/parameters/outcomes/transition-smoothness/) ↓ — Effective institutions manage disruption and maintain legitimacy

...
- [Acute Risk](/knowledge-base/parameters/outcomes/acute-risk/) ↓↓ — Coordination prevents racing dynamics and enables collective response
- [Transition Smoothness](/knowledge-base/parameters/outcomes/transition-smoothness/) ↓↓ — International frameworks manage global disruption
- [Steady State](/knowledge-base/parameters/outcomes/steady-state/) ↓↓ — Who governs AI shapes long-term power distribution

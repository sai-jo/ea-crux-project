...
- [Steady State](/knowledge-base/parameters/outcomes/steady-state/) ↓↓ — Shared reality enables collective decision-making about the future
- [Transition Smoothness](/knowledge-base/parameters/outcomes/transition-smoothness/) ↓ — Coordination during upheaval requires common understanding

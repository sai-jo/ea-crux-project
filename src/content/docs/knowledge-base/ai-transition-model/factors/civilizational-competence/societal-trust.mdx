...
- [Transition Smoothness](/knowledge-base/parameters/outcomes/transition-smoothness/) ↓↓ — Trust enables collective action during upheaval
- [Steady State](/knowledge-base/parameters/outcomes/steady-state/) ↓ — Democratic governance requires public trust in institutions

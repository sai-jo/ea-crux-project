...
flowchart LR
    ...
    HOQ --> TECH[Technical Safety]
    HOQ --> ACUTE[Acute Risk ↓↓]
...
- [Acute Risk](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) ↓↓ — Oversight catches dangerous behaviors before catastrophe
- [Steady State](/knowledge-base/ai-transition-model/outcomes/long-term-trajectory/) ↓ — Quality oversight preserves human agency in the long term
...
### Related Parameters
- [Human Agency](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/) — Personal autonomy in AI-mediated decisions
- [Human Expertise](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-expertise/) — Expertise required for effective oversight
- [Interpretability Coverage](/knowledge-base/ai-transition-model/factors/misalignment-potential/interpretability-coverage/) — Understanding AI decisions enables better oversight
- [Alignment Robustness](/knowledge-base/ai-transition-model/factors/misalignment-potential/alignment-robustness/) — Stronger alignment reduces oversight burden
- [Societal Trust](/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-trust/) — Public confidence in AI governance

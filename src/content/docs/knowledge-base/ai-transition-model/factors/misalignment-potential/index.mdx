...
|-----------|------|---------------|
| [Alignment Robustness](/knowledge-base/parameters/alignment-robustness/) | Core outcome: do systems pursue intended goals? | Concerning (12-78% alignment faking in studies) |
| [Safety-Capability Gap](/knowledge-base/parameters/safety-capability-gap/) | Can safety research keep pace with capabilities? | Widening gap |
| [Interpretability Coverage](/knowledge-base/parameters/interpretability-coverage/) | Can we understand what's happening inside? | ~10% coverage, improving |
| [Human Oversight Quality](/knowledge-base/parameters/human-oversight-quality/) | Can humans catch and correct problems? | Declining relative to AI speed |
| [Safety Culture Strength](/knowledge-base/parameters/safety-culture-strength/) | Do organizations prioritize safety? | Variable (6-12% of R&D) |
...
|---------|--------|-----------|
| [Acute Risk](/knowledge-base/parameters/outcomes/acute-risk/) | ↓↓↓ Primary | Aligned, interpretable, overseen systems are less likely to cause catastrophe |
| [Steady State](/knowledge-base/parameters/outcomes/steady-state/) | ↓ Secondary | Technical control shapes who can direct AI and toward what ends |
| [Transition](/knowledge-base/parameters/outcomes/transition-smoothness/) | ↓ Secondary | Safer systems can be deployed more widely with less disruption |
...
- [Threat Environment](/knowledge-base/parameters/aggregates/threat-environment/) — The opposing force increasing acute risk

...
**Contributes to:** [Technical Safety Capacity](/knowledge-base/parameters/aggregates/technical-safety/) (inverse — wider gap means lower safety capacity)

**Primary outcomes affected:**
- [Acute Risk](/knowledge-base/parameters/outcomes/acute-risk/) ↑↑↑ — A wide gap means deploying systems we don't understand how to make safe

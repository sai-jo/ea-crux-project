...
flowchart LR
    ...
    SCS --> TECH[Technical Safety]
    SCS --> ACUTE[Acute Risk ↓↓]
...
- [Acute Risk](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) ↓↓ — Strong safety culture ensures safety practices persist under pressure
...
- **Capability racing**: Safety sacrificed for competitive position (weak culture correlates with 30-60% reduction in safety investment under [racing pressure](/knowledge-base/ai-transition-model/factors/transition-turbulence/racing-intensity/))
...
- Leadership must genuinely believe in safety for culture to persist under [racing pressure](/knowledge-base/ai-transition-model/factors/transition-turbulence/racing-intensity/)
...
### Related Parameters
- [Racing Intensity](/knowledge-base/ai-transition-model/factors/transition-turbulence/racing-intensity/) — External competitive pressure driving cultural weakening
- [Coordination Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/coordination-capacity/) — Industry cooperation enabling stronger collective culture
- [Regulatory Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/regulatory-capacity/) — Government ability to enforce safety standards

...
- [Acute Risk](/knowledge-base/parameters/outcomes/acute-risk/) ↑↑ — Concentrated control creates single points of failure/capture
- [Steady State](/knowledge-base/parameters/outcomes/steady-state/) ↑↑↑ — Who controls AI shapes long-term power distribution

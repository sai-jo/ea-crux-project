...
flowchart LR
    ...
    ACC --> THREAT[Threat Environment]
    ACC --> ACUTE[Acute Risk ↑↑]
...
- [Acute Risk](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) ↑↑ — Concentrated control creates single points of failure/capture
- [Steady State](/knowledge-base/ai-transition-model/outcomes/long-term-trajectory/) ↑↑↑ — Who controls AI shapes long-term power distribution
...
This debate intersects directly with [coordination-capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/coordination-capacity/) and [international-coordination](/knowledge-base/ai-transition-model/factors/civilizational-competence/international-coordination/) parameters.
...
### Related Parameters
- [Coordination Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/coordination-capacity/) — How effectively actors coordinate on AI governance; directly shaped by power distribution
- [International Coordination](/knowledge-base/ai-transition-model/factors/civilizational-competence/international-coordination/) — Global coordination capacity; affected by geopolitical power distribution
- [Societal Trust](/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-trust/) — Public trust in AI institutions; undermined by concentration without accountability
- [Human Agency](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/) — Individual autonomy in AI systems; reduced by concentrated algorithmic control

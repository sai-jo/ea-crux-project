...
- [Transition Smoothness](/knowledge-base/ai-transition-model/factors/transition-turbulence/) ↓↓↓ — Economic stability is the primary factor in smooth transitions
...
### Related Parameters
- [Human Agency](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/) — Economic security enables meaningful choice
- [Societal Trust](/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-trust/) — Economic disruption erodes trust in institutions
- [AI Control Concentration](/knowledge-base/ai-transition-model/factors/misuse-potential/ai-control-concentration/) — Capital-labor imbalance concentrates power

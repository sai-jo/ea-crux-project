...
| [State-Caused Catastrophe](/knowledge-base/ai-transition-model/scenarios/human-catastrophe/state-actor/) | Turbulence can trigger state failures |
| [Value Lock-in](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/values/) | Turbulent periods often lock in emergency measures |
| [Epistemic Trajectory](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/epistemics/) | Turbulence strains information environment |
| [Power Transition](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/power/) | Turbulence affects how power shifts |
...
- [Value Lock-in](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/values/) — Crisis periods often lock in values
- [Power Transition](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/power/) — Turbulence affects power shifts

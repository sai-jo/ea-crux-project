...
Transition Turbulence measures how much disruption occurs as society navigates from current AI to whatever future emerges. Unlike [Ultimate Scenarios](/knowledge-base/ai-transition-model/scenarios/) (which describe *what* happens), Transition Turbulence describes *how rough the journey is*—and that roughness affects both whether we survive ([Existential Catastrophe](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/)) and what world we end up in ([Long-term Trajectory](/knowledge-base/ai-transition-model/outcomes/long-term-trajectory/)).
...
|-----------|-----------|--------|
| [Racing Intensity](/knowledge-base/ai-transition-model/factors/transition-turbulence/racing-intensity/) | High → More turbulence | Faster change, less time to adapt |
| [Societal Resilience](/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-resilience/) | Low → More turbulence | Less capacity to absorb shocks |
| [Economic Stability](/knowledge-base/ai-transition-model/factors/transition-turbulence/economic-stability/) | Low → More turbulence | Economic disruption cascades |
| [Regulatory Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/regulatory-capacity/) | Low → More turbulence | Governance can't keep pace |
| [International Coordination](/knowledge-base/ai-transition-model/factors/civilizational-competence/international-coordination/) | Low → More turbulence | No coordinated response |
| [Societal Trust](/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-trust/) | Low → More turbulence | Social cohesion breaks down |
...
|---------------------|--------------|
| [AI Takeover](/knowledge-base/ai-transition-model/scenarios/ai-takeover/) | Turbulence increases risk of loss of control |
| [Human-Caused Catastrophe](/knowledge-base/ai-transition-model/scenarios/human-catastrophe/) | Turbulence can trigger state failures and desperate actions |
| [Long-term Lock-in](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/) | Turbulent periods often lock in emergency measures |
...
### Ultimate Outcomes
- [Acute Risk](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) — Turbulence can trigger catastrophes
- [Long-run Value](/knowledge-base/ai-transition-model/outcomes/long-term-trajectory/) — Turbulence shapes achievable futures

### Ultimate Scenarios
- [Long-term Lock-in](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/) — Crisis periods often lock in values/power structures
- [AI Takeover](/knowledge-base/ai-transition-model/scenarios/ai-takeover/) — Turbulence increases loss of control risk

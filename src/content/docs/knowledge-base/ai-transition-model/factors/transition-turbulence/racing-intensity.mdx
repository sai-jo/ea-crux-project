...
**Contributes to:** [Governance Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/governance/) (inverse), [Threat Environment](/knowledge-base/ai-transition-model/factors/misuse-potential/)

**Primary outcomes affected:**
- [Acute Risk](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) ↑↑↑ — Racing degrades safety margins, widening the safety-capability gap
- [Transition Smoothness](/knowledge-base/ai-transition-model/factors/transition-turbulence/) ↑↑ — Racing creates instability and undermines coordination
...
### Related Parameters
- [Safety Culture Strength](/knowledge-base/ai-transition-model/factors/misalignment-potential/safety-culture-strength/) — Internal safety prioritization that resists racing pressure
- [Coordination Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/coordination-capacity/) — Industry cooperation that reduces competitive intensity
- [International Coordination](/knowledge-base/ai-transition-model/factors/civilizational-competence/international-coordination/) — Geopolitical cooperation level
- [Regulatory Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/regulatory-capacity/) — Government ability to moderate racing through policy
- [Safety-Capability Gap](/knowledge-base/ai-transition-model/factors/misalignment-potential/safety-capability-gap/) — The gap that racing widens
- [AI Control Concentration](/knowledge-base/ai-transition-model/factors/misuse-potential/ai-control-concentration/) — Concentration dynamics from racing outcomes

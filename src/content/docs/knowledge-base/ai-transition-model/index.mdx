...
description: A causal model of how root factors shape structural scenarios and outcomes during the AI transition period.
sidebar:
  label: Overview
  order: 0
...
import {EmbeddedParameterGraph, ParameterFlowDiagram, ParametersTable} from '../../../../components/wiki';
...
- **Structural Scenarios**: The pathways through which factors lead to outcomes
...
The model flows through three levels: **Root Factors** → **Structural Scenarios** → **Ultimate Outcomes**. Click nodes to navigate to their pages, or [view fullscreen](/parameter-graph/).
...
| Outcome | Question | Key Structural Scenarios |
|---------|----------|------------------------|
...
Structural Scenarios are the intermediate pathways connecting root factors to ultimate outcomes—they describe *how* factor changes lead to catastrophe or shape the long-term future.

| Structural Scenario | Description | Key Root Factors | Ultimate Outcomes |
|-------------------|-------------|------------------|-------------------|
...
Each root factor aggregates underlying parameters and influences structural scenarios:

| Root Factor | Description | Sub-components | Scenarios Influenced |
|-------------|-------------|----------------|---------------------|
| [Misalignment Potential](/knowledge-base/ai-transition-model/factors/misalignment-potential/) | Potential for AI to be misaligned | Alignment Robustness, Interpretability Coverage, Human Oversight Quality, Safety Capability Gap, Safety Culture Strength | AI Takeover ↑ |
| [AI Capabilities](/knowledge-base/ai-transition-model/factors/ai-capabilities/) | How powerful AI systems become | Speed, Generality, Autonomy | AI Takeover ↑ |
...
| [Misuse Potential](/knowledge-base/ai-transition-model/factors/misuse-potential/) | Potential for AI to be misused for harm | Biological Threat Exposure, Cyber Threat Exposure, AI Control Concentration | Human-Caused Catastrophe ↑ |

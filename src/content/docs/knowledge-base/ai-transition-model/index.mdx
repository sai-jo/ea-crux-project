...
The model flows through three levels: **Root Factors** → **Ultimate Scenarios** → **Ultimate Outcomes**. Click nodes to navigate to their pages, or [view fullscreen](/parameter-graph/).

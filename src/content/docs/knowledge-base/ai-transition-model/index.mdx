...
<ParameterFlowDiagram
  ...
  nodes={[
    ...
    { id: 'alignment-robustness', title: 'Alignment Robustness', type: 'parameter', href: '/knowledge-base/ai-transition-model/factors/misalignment-potential/alignment-robustness/' },
    { id: 'racing-intensity', title: 'Racing Intensity', type: 'parameter', href: '/knowledge-base/ai-transition-model/factors/transition-turbulence/racing-intensity/' },
    { id: 'societal-trust', title: 'Societal Trust', type: 'parameter', href: '/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-trust/' },
    { id: 'human-agency', title: 'Human Agency', type: 'parameter', href: '/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/' },
    { id: 'biological-threat-exposure', title: 'Biological Threat Exposure', type: 'parameter', href: '/knowledge-base/ai-transition-model/factors/misuse-potential/biological-threat-exposure/' },

...
Unlike [Transition Smoothness](/knowledge-base/parameters/outcomes/transition-smoothness/) (which concerns the journey) or [Steady State Quality](/knowledge-base/parameters/outcomes/steady-state/) (which concerns the destination), Acute Risk is about avoiding catastrophe entirely. A world with high acute risk might navigate a smooth transition to a good steady state—or might not make it there at all.
...
|-----------|--------------|-----------|
| [Technical Safety Capacity](/knowledge-base/parameters/aggregates/technical-safety/) | ↓↓↓ Decreases risk | Aligned, interpretable, overseen systems are less likely to cause catastrophe |
| [Threat Environment](/knowledge-base/parameters/aggregates/threat-environment/) | ↑↑↑ Increases risk | Higher bio/cyber exposure, concentration, and racing all elevate acute risk |
| [Governance Capacity](/knowledge-base/parameters/aggregates/governance-capacity/) | ↓↓ Decreases risk | Effective governance can slow racing, enforce safety standards, coordinate responses |

### Key Individual Parameters

| Parameter | Effect | Strength |
|-----------|--------|----------|
| [Alignment Robustness](/knowledge-base/parameters/alignment-robustness/) | ↓ Reduces | ↓↓↓ Critical |
| [Safety-Capability Gap](/knowledge-base/parameters/safety-capability-gap/) | ↑ Increases | ↑↑↑ Critical |
| [Racing Intensity](/knowledge-base/parameters/racing-intensity/) | ↑ Increases | ↑↑↑ Strong |
| [Human Oversight Quality](/knowledge-base/parameters/human-oversight-quality/) | ↓ Reduces | ↓↓ Strong |
| [Interpretability Coverage](/knowledge-base/parameters/interpretability-coverage/) | ↓ Reduces | ↓↓ Strong |
| [AI Control Concentration](/knowledge-base/parameters/ai-control-concentration/) | ↑/↓ Depends | ↑↑ Context-dependent |
| [Biological Threat Exposure](/knowledge-base/parameters/biological-threat-exposure/) | ↑ Increases | ↑↑ Direct |
| [Cyber Threat Exposure](/knowledge-base/parameters/cyber-threat-exposure/) | ↑ Increases | ↑↑ Direct |
...
- [Long-term Steady State Quality](/knowledge-base/parameters/outcomes/steady-state/) — The destination (if we avoid catastrophe)
- [Transition Smoothness](/knowledge-base/parameters/outcomes/transition-smoothness/) — The journey quality
...
- [Technical Safety Capacity](/knowledge-base/parameters/aggregates/technical-safety/)
- [Threat Environment](/knowledge-base/parameters/aggregates/threat-environment/)

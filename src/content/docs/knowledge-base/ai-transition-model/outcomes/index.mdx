...
1. **[Acute Risk](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/)** — Does catastrophe occur?
2. **[Long-run Value](/knowledge-base/ai-transition-model/outcomes/long-term-trajectory/)** — What's the expected value of the future?
...
|---------|----------|-------|
| [**Acute Risk**](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) | "Does catastrophe occur?" | The transition period |
| [**Long-run Value**](/knowledge-base/ai-transition-model/outcomes/long-term-trajectory/) | "What's the future worth?" | Post-resolution trajectory |
...
1. **Transition Turbulence is a pathway, not endpoint**: How rough the transition is affects *both* acute risk and long-run value. It belongs in [Critical Outcomes](/knowledge-base/ai-transition-model/factors/transition-turbulence/).
...
|------------------|-------------------|----------------------|
| [Transition Turbulence](/knowledge-base/ai-transition-model/factors/transition-turbulence/) | Yes (can trigger) | Yes (path dependence) |
| [Rapid AI Takeover](/knowledge-base/ai-transition-model/scenarios/ai-takeover/rapid/) | Yes (primary) | — |
| [Gradual AI Takeover](/knowledge-base/ai-transition-model/scenarios/ai-takeover/gradual/) | Yes | Yes |
| [State-Caused Catastrophe](/knowledge-base/ai-transition-model/scenarios/human-catastrophe/state-actor/) | Yes | — |
| [Rogue Actor Catastrophe](/knowledge-base/ai-transition-model/scenarios/human-catastrophe/rogue-actor/) | Yes | — |
| [Value Lock-in](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/values/) | Yes (bad lock-in) | Yes (primary) |
| [Epistemic Trajectory](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/epistemics/) | — | Yes |
| [Power Transition](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/power/) | — | Yes |

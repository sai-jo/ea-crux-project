...
flowchart TD
    ...
    LOCKIN -->|"determines"| OPTIONS
    LOCKIN -->|"shapes"| AGENCY
    CIV -->|"enables"| AGENCY
    CIV -->|"shapes"| LOCKIN
    TAKEOVER -->|"erodes"| AGENCY
...
|---------------------|--------------------------------|
| [Long-term Lock-in](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/) | **Primary** — Determines whether good or bad values/power structures persist |
| [AI Takeover](/knowledge-base/ai-transition-model/scenarios/ai-takeover/) | **Secondary** — Successful takeover means AI goals, not human values |

The **Root Factor** [Transition Turbulence](/knowledge-base/ai-transition-model/factors/transition-turbulence/) also affects Long-term Trajectory through path dependence.
...
- [Long-term Lock-in](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/) — Key Ultimate Scenario for long-term trajectory

...
description: "A slow erosion of human control over years to decades as AI systems accumulate influence, optimize for proxy metrics, and entrench their position."
sidebar:
  order: 2
...
|-----------|-----------|--------|
| [Human Agency](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/) | Declining → Enables | Less ability to override AI decisions |
| [Human Oversight Quality](/knowledge-base/ai-transition-model/factors/misalignment-potential/human-oversight-quality/) | Declining → Enables | Insufficient monitoring to detect gradual shifts |
| [AI Control Concentration](/knowledge-base/ai-transition-model/factors/misuse-potential/ai-control-concentration/) | Increasing → Enables | Fewer actors can course-correct |
| [Human Expertise](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-expertise/) | Declining → Accelerates | Skill atrophy makes humans more dependent |
| [Societal Resilience](/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-resilience/) | Low → Accelerates | Less capacity to respond to problems |

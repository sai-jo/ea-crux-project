...
|-----------|-----------|--------|
| [Human Agency](/knowledge-base/parameters/human-agency/) | Declining → Enables | Less ability to override AI decisions |
| [Human Oversight Quality](/knowledge-base/parameters/human-oversight-quality/) | Declining → Enables | Insufficient monitoring to detect gradual shifts |
| [AI Control Concentration](/knowledge-base/parameters/ai-control-concentration/) | Increasing → Enables | Fewer actors can course-correct |
| [Human Expertise](/knowledge-base/parameters/human-expertise/) | Declining → Accelerates | Skill atrophy makes humans more dependent |
| [Societal Resilience](/knowledge-base/parameters/societal-resilience/) | Low → Accelerates | Less capacity to respond to problems |

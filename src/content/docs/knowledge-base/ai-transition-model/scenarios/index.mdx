...
Critical Outcomes are the intermediate scenarios that connect [aggregate parameters](/knowledge-base/ai-transition-model/factors/) to [ultimate outcomes](/knowledge-base/ai-transition-model/outcomes/). They describe *how* parameters lead to catastrophe (or success)—the specific mechanisms and pathways that determine what kind of future we get.
...
|-----------------|----------|---------------|----------------|-------------------|
| [Transition Turbulence](/knowledge-base/ai-transition-model/factors/transition-turbulence/) | Negative | Economic/political disruption | Societal Adaptability | Acute Risk, Long-run Value |
| [Rapid AI Takeover](/knowledge-base/ai-transition-model/scenarios/ai-takeover/rapid/) | Negative | Intelligence explosion, treacherous turn | Technical Safety, Threat Environment | Acute Risk |
| [Gradual AI Takeover](/knowledge-base/ai-transition-model/scenarios/ai-takeover/gradual/) | Negative | Erosion of control, proxy gaming | Technical Safety, Governance, Epistemic | Acute Risk, Long-run Value |
| [State-Caused Catastrophe](/knowledge-base/ai-transition-model/scenarios/human-catastrophe/state-actor/) | Negative | Government weaponization, great power conflict | Threat Environment, Governance | Acute Risk → Lock-in |
| [Rogue Actor Catastrophe](/knowledge-base/ai-transition-model/scenarios/human-catastrophe/rogue-actor/) | Negative | Terrorism, lone wolf attacks | Threat Environment | Acute Risk |
| [Value Lock-in](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/values/) | Symmetric | Power concentration, irreversibility | Governance, Adaptability | Acute Risk, Long-run Value |
| [Epistemic Quality](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/epistemics/) | Symmetric | Information environment, trust dynamics | Epistemic Foundation | Long-run Value |
| [Power Transition](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/power/) | Neutral | AI-human power shift dynamics | Societal Adaptability | Long-run Value |
...
- [Aggregate Parameters](/knowledge-base/ai-transition-model/factors/) — The parameter groupings that feed into critical outcomes
- [Ultimate Outcomes](/knowledge-base/ai-transition-model/outcomes/) — The high-level goals critical outcomes affect

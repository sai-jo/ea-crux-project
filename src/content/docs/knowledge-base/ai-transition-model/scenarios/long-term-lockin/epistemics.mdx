...
description: "The quality of humanity's collective ability to find truth—could collapse into fragmented realities or flourish with AI-enhanced knowledge systems."
sidebar:
  order: 6
...
|-----------|-----------|--------|
| [Epistemic Health](/knowledge-base/ai-transition-model/factors/civilizational-competence/epistemic-health/) | Primary measure | Directly tracking this outcome |
| [Information Authenticity](/knowledge-base/ai-transition-model/factors/civilizational-competence/information-authenticity/) | High → Renaissance | Distinguishing real from fake |
| [Societal Trust](/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-trust/) | High → Renaissance | Foundation for collective knowledge |
| [Human Expertise](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-expertise/) | High → Renaissance | Capacity to evaluate information |
...
Epistemic collapse increases acute risks:

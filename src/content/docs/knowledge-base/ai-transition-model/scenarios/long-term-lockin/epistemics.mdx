...
|-----------|-----------|--------|
| [Epistemic Health](/knowledge-base/parameters/epistemic-health/) | Primary measure | Directly tracking this outcome |
| [Information Authenticity](/knowledge-base/parameters/information-authenticity/) | High → Renaissance | Distinguishing real from fake |
| [Societal Trust](/knowledge-base/parameters/societal-trust/) | High → Renaissance | Foundation for collective knowledge |
| [Human Expertise](/knowledge-base/parameters/human-expertise/) | High → Renaissance | Capacity to evaluate information |

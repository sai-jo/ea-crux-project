...
|-----------|---------------------|
| [Safety-Capability Gap](/knowledge-base/ai-transition-model/factors/misalignment-potential/safety-capability-gap/) | Larger gap → less smooth transition |
| [Human Agency](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/) | Higher → more human-led transition |
| [Human Expertise](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-expertise/) | Higher → humans can meaningfully participate |
| [Societal Adaptability](/knowledge-base/ai-transition-model/factors/civilizational-competence/adaptability/) | Higher → better handling of disruption |
| [Racing Intensity](/knowledge-base/ai-transition-model/factors/transition-turbulence/racing-intensity/) | Higher → faster, less controlled transition |
| [Coordination Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/coordination-capacity/) | Higher → better collective management |
...
- Effectively equivalent to [AI Takeover - Gradual](/knowledge-base/ai-transition-model/scenarios/ai-takeover/gradual/) if values misaligned
...
### Existing Pages
- [Long-run Value](/knowledge-base/ai-transition-model/outcomes/long-term-trajectory/) — The ultimate outcome this affects
- [Transition Turbulence](/knowledge-base/ai-transition-model/factors/transition-turbulence/) — Related critical outcome
- [Societal Adaptability](/knowledge-base/ai-transition-model/factors/civilizational-competence/adaptability/) — Key aggregate for this outcome

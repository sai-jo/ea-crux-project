---
title: "Value Lock-in"
description: "Permanent entrenchment of values through AI-enabled power concentration—could entrench beneficial values or lock in authoritarian, corporate, or ideological control."
sidebar:
  order: 5
...
|-----------|-----------|---------------------------|
| [AI Control Concentration](/knowledge-base/ai-transition-model/factors/misuse-potential/ai-control-concentration/) | High → Enables | Few actors can entrench their values |
| [Human Agency](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/) | Low → Enables | Less capacity to resist or change course |
| [Governance Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/governance/) | Low → Enables | Institutions can't prevent capture |
| [Societal Resilience](/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-resilience/) | Low → Enables | Less ability to recover from bad lock-in |
| [Epistemic Health](/knowledge-base/ai-transition-model/factors/civilizational-competence/epistemic-health/) | Low → Enables | Harder to recognize bad values being locked in |

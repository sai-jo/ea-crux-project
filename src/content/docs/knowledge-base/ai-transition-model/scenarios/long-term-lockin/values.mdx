...
|-----------|-----------|---------------------------|
| [AI Control Concentration](/knowledge-base/parameters/ai-control-concentration/) | High → Enables | Few actors can entrench their values |
| [Human Agency](/knowledge-base/parameters/human-agency/) | Low → Enables | Less capacity to resist or change course |
| [Governance Capacity](/knowledge-base/parameters/aggregates/governance-capacity/) | Low → Enables | Institutions can't prevent capture |
| [Societal Resilience](/knowledge-base/parameters/societal-resilience/) | Low → Enables | Less ability to recover from bad lock-in |
| [Epistemic Health](/knowledge-base/parameters/epistemic-health/) | Low → Enables | Harder to recognize bad values being locked in |

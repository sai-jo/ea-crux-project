...
<InfoBox
  type="capability"
  title="Reasoning and Planning"
  currentLevel="o1-class models"
  projectedTimeline="Rapid improvement expected"
  customFields={[
    { label: "Safety Relevance", value: "Very High" },
    { label: "Key Models", value: "OpenAI o1, o3" },
  ]}
/>
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      description="Foundation for reasoning capabilities"
    />
    <EntityCard
      id="self-improvement"
      category="capability"
      title="Self-Improvement"
      description="Enabled by reasoning capabilities"
    />
    <EntityCard
      id="openai"
      category="lab"
      title="OpenAI"
      description="Developer of o1 and o3"
    />
  </EntityCards>
</Section>

<Sources sources={[
  { title: "Learning to Reason with LLMs", url: "https://openai.com/index/learning-to-reason-with-llms/", author: "OpenAI" },

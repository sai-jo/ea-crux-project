...
<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="Comprehensive analysis of 11 critical cruxes that determine views on AI accident risks, covering foundational questions about mesa-optimizers and deceptive alignment, alignment difficulty (scalable oversight, interpretability), capability emergence, and specific failure modes like power-seeking and corrigibility." />

## What Are Accident Risk Cruxes?

**Cruxes** are the key uncertainties where your answer largely determines your overall view. For accident risks, your positions on these cruxes shape which failure modes you expect, how hard you think alignment is, which research directions deserve priority, and how much runway we have before transformative AI.

These cruxes cut across specific accident risks (deceptive alignment, mesa-optimization, etc.) to identify the deeper disagreements that drive divergent conclusions.

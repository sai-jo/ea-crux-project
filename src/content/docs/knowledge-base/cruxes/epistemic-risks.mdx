...
<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="Detailed examination of 9 epistemic cruxes covering authentication and verification (detection vs provenance, C2PA adoption), social epistemics (trust rebuilding, polarization), human factors (expertise preservation, sycophancy), and coordination feasibility, with analysis of how different positions on these uncertainties lead to different solution priorities." />

## What Are Epistemic Cruxes?

**Cruxes** are the key uncertainties where your answer determines your overall view on an issue. For epistemic risks and solutions, your position on a few key cruxes largely determines which failure modes you expect, which solutions you prioritize, how urgent the problem is, and whether defense or offense will dominate.

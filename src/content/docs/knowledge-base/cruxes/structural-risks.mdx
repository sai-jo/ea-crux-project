...
<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="In-depth analysis of 12 structural risk cruxes covering foundational questions (whether structural risks are distinct, AI power concentration), competition and coordination dynamics (racing inevitability, international cooperation), power and lock-in concerns (winner-take-all, value crystallization), human agency questions (capability atrophy, oversight feasibility), and systemic dynamics including institutional adaptation speed." />

## What Are Structural Risk Cruxes?

**Cruxes** are the key uncertainties where your answer largely determines your overall view. For structural risks, your positions on these cruxes shape whether you think structural risks are real and distinct, how urgent they are, which interventions to prioritize, and whether to focus on structural dynamics or individual failures.

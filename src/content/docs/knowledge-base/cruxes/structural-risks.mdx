...
import {Crux, CruxList, Mermaid} from '../../../../components/wiki';
...
|--------|-------|--------|------|
| Top 3 cloud providers' AI market share | 65-70% | [Korinek & Vipra](https://www.ineteconomics.org/uploads/papers/WP_228-Korinek-and-Vipra.pdf) | 2024 |
...
| Microsoft investment in OpenAI | greater than $13 billion | [CRS](https://www.congress.gov/crs-product/IF12968) | 2024 |
...
In July 2024, the DOJ, FTC, UK CMA, and European Commission released a [joint statement](https://www.congress.gov/crs-product/IF12968) specifying three competition concerns: concentrated control of key inputs (chips, compute, talent), incumbent digital firms extending power into AI markets, and arrangements among key players reducing competition.
...
Despite these diplomatic milestones, fundamental tensions persist. The US ties AI exports to political alignment through chip export controls, while China promotes "[open cooperation with fewer conditions](https://www.chinausfocus.com/finance-economy/us-and-chinese-ai-strategies-competing-global-approaches)." Former Google CEO Eric Schmidt has [called for explicit US-China collaboration](https://www.techpolicy.press/from-competition-to-cooperation-can-uschina-engagement-overcome-geopolitical-barriers-in-ai-governance/), stating both nations have "a vested interest to keep the world stable" and ensure "human control of these tools."
...
The [Forethought Foundation's analysis](https://www.forethought.org/research/agi-and-lock-in) notes that AGI could make it "technologically feasible to perfectly preserve nuanced specifications of a wide variety of values or goals far into the future"—potentially for "millions, and plausibly trillions, of years." The [World Economic Forum's 2024 white paper on AI Value Alignment](https://www.weforum.org/stories/2024/10/ai-value-alignment-how-we-can-align-artificial-intelligence-with-human-values/) explores how to guide AI systems toward shared human values while preserving adaptability.
...
|---------|--------|-------------|
| 39% of existing skills will be transformed or outdated by 2030 | [World Economic Forum](https://www.weforum.org/stories/2024/10/generative-ai-governments-keep-pace/) | Massive reskilling need |
...
A 2024 paper titled "[The Paradox of Augmentation: A Theoretical Model of AI-Induced Skill Atrophy](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4974044)" directly addresses the concern that skills erode as humans rely on AI augmentation. Research published in *New Biotechnology* (2025) by [Holzinger et al.](https://pubmed.ncbi.nlm.nih.gov/39675423/) examines challenges of human oversight in complex AI systems, noting that "as AI systems grow increasingly complex, opaque, and autonomous, ensuring responsible use becomes a formidable challenge."
...
- May 2024: Council of Europe adopted first [international AI treaty](https://www.nature.com/articles/s41599-024-03560-x) on human rights and democracy
- 2024: UN established High-Level Advisory Body on AI
- 2024: Seoul Summit produced voluntary [Frontier AI Safety Commitments](https://www.aisafetybook.com/textbook/ai-race) from 16 major AI companies
...
- [Korinek & Vipra (2025): Concentrating Intelligence: Scaling and Market Structure in AI](https://www.ineteconomics.org/uploads/papers/WP_228-Korinek-and-Vipra.pdf) - Economic analysis of AI market concentration
- [Gans (2024): Market Power in Artificial Intelligence](https://www.nber.org/papers/w32270) - NBER analysis of competition drivers
- [Ganuthula (2024): The Paradox of Augmentation](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4974044) - Theoretical model of AI-induced skill atrophy
- [Holzinger et al. (2025): Is human oversight to AI systems still possible?](https://pubmed.ncbi.nlm.nih.gov/39675423/) - *New Biotechnology* analysis of oversight challenges
- [AI Governance in a Complex Regulatory Landscape](https://www.nature.com/articles/s41599-024-03560-x) - *Humanities and Social Sciences Communications* global perspective

### Policy Reports

- [Congressional Research Service: Competition and Antitrust Concerns Related to Generative AI](https://www.congress.gov/crs-product/IF12968) - 2024 analysis of US competition issues
- [AI Now Institute: Artificial Power](https://ainowinstitute.org/publications/research/executive-summary-artificial-power) - Concentration and power in AI
- [Open Markets Institute: AI and Market Concentration](https://www.openmarketsinstitute.org/publications/expert-brief-ai-and-market-concentration-courtney-radsch-max-vonthun) - Expert brief on concentration concerns
- [Carnegie Endowment: The AI Governance Arms Race](https://carnegieendowment.org/research/2024/10/the-ai-governance-arms-race-from-summit-pageantry-to-progress?lang=en) - Analysis of governance coordination

### International Governance

- [Sandia National Labs: US-China AI Collaboration Challenges](https://www.sandia.gov/app/uploads/sites/148/2025/04/Challenges-and-Opportunities-for-US-China-Collaboration-on-Artificial-Intelligence-Governance.pdf) - 2025 analysis of cooperation barriers
- [TechPolicy.Press: From Competition to Cooperation](https://www.techpolicy.press/from-competition-to-cooperation-can-uschina-engagement-overcome-geopolitical-barriers-in-ai-governance/) - US-China engagement analysis
- [China's Global AI Governance Action Plan](https://www.fmprc.gov.cn/eng./xw/zyxw/202507/t20250729_11679232.html) - Ministry of Foreign Affairs (July 2025)

### Value Lock-in and Long-term Risks

- [Forethought Foundation: AGI and Lock-in](https://www.forethought.org/research/agi-and-lock-in) - Analysis of permanent value lock-in
- [World Economic Forum: AI Value Alignment](https://www.weforum.org/stories/2024/10/ai-value-alignment-how-we-can-align-artificial-intelligence-with-human-values/) - 2024 white paper on alignment with human values
- [The Precipice (Ord, 2020)](https://theprecipice.com/) - Framework for existential risk including lock-in
- [What We Owe the Future (MacAskill, 2022)](https://whatweowethefuture.com/) - Longtermist perspective on value evolution

### Racing Dynamics

- [AI Safety Textbook: AI Race](https://www.aisafetybook.com/textbook/ai-race) - Comprehensive analysis of competitive dynamics
- [TNSR: Debunking the AI Arms Race Theory](https://tnsr.org/2021/06/debunking-the-ai-arms-race-theory/) - Skeptical perspective on arms race framing
- [Bostrom: Racing to the Precipice](https://nickbostrom.com/papers/racing.pdf) - Original model of AI development races

### Institutional Adaptation

- [World Economic Forum: Governance in the Age of Generative AI](https://www.weforum.org/publications/governance-in-the-age-of-generative-ai/) - 2024 governance framework
- [Stanford FSI: Regulating Under Uncertainty](https://cyber.fsi.stanford.edu/content/regulating-under-uncertainty-governance-options-generative-ai) - Governance options analysis
- [WEF: GenAI is rapidly evolving](https://www.weforum.org/stories/2024/10/generative-ai-governments-keep-pace/) - How governments can keep pace
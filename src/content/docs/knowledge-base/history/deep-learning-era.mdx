...
<PageStatus quality={4} lastEdited="2025-12-23" llmSummary="Chronicles the 2012-2020 period when deep learning breakthroughs (AlexNet, AlphaGo, GPT) transformed AI safety from theoretical speculation to urgent technical challenge, establishing key safety research agendas and revealing widening capabilities-safety gaps." todo="Add more details on international AI competition dynamics and their impact on safety research; expand discussion of specific technical safety papers beyond 'Concrete Problems'" />

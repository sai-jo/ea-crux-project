...
<PageStatus quality={3} lastEdited="2025-12-23" llmSummary="Covers 2020-present period when ChatGPT's explosive growth and subsequent AI race brought safety concerns mainstream, spurring government regulation (EU AI Act, US executive orders), high-profile warnings from AI pioneers, and the OpenAI governance crisis, while technical alignment solutions remain unsolved and timelines continue to shorten." todo="Update with latest developments from 2024-2025; add more detail on Chinese AI policy and international coordination efforts; expand discussion of specific safety research results and their practical impact on deployed systems" />

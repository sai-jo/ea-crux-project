...
A [comprehensive study from August 2025](https://arxiv.org/abs/2508.08345) examining companies' adherence to their White House voluntary AI commitments found significant variation:
...
[Anthropic pioneered the Responsible Scaling Policy](https://www.anthropic.com/rsp-updates) approach in September 2023, with the policy now at Version 2.2 (effective May 14, 2025):
...
Anthropic [activated ASL-3 protections](https://www.anthropic.com/news/activating-asl3-protections) for Claude Opus 4, representing the first publicly confirmed capability threshold crossing:
...
The [Financial Times reported](https://www.ft.com/content/safety-testing-compression) that OpenAI has been **slashing safety evaluation time**, giving testers "just a few days for evaluations that had previously been allotted weeks or months to be completed."
...
[METR](https://metr.org/blog/2025-01-17-ai-models-dangerous-before-public-deployment/) and other evaluation organizations report that comprehensive risk assessments require:
...
The [2025 AI Safety Index](https://futureoflife.org/ai-safety-index-summer-2025/) from Future of Life Institute found:
...
[Anthropic partnered with HackerOne](https://www.hackerone.com/blog/how-anthropics-jailbreak-challenge-put-ai-safety-defenses-test) to test Constitutional Classifiers on Claude 3.5 Sonnet:
...
[Google released Gemini 2.5 Pro](https://fortune.com/2025/04/09/google-gemini-2-5-pro-missing-model-card-in-apparent-violation-of-ai-safety-promises-to-us-government-international-bodies/) **without a model card**, violating commitments made to the U.S. government and at international AI safety summits:

| Timeline | Event | Notes |
|----------|-------|-------|
| March 2025 | Gemini 2.5 Pro released | No model card published |
| 3 weeks later | Simplified 6-page model card | [Called "meager" and "worrisome"](https://fortune.com/article/google-gemini-2-5-pro-model-card-published-ai-governance-expert-criticizes-it-as-meager-and-worrisome/) by AI governance experts |
| Late June 2025 | Detailed report published | Months after full release |

**Government Response:** [60 U.K. politicians signed an open letter](https://fortune.com/2025/08/29/british-lawmakers-accuse-google-deepmind-of-breach-of-trust-over-delayed-gemini-2-5-pro-safety-report/) accusing Google DeepMind of "a troubling breach of trust with governments and the public" and a "failure to honour" international commitments.
...
- [OpenAI's Preparedness Framework](https://openai.com/index/updating-our-preparedness-framework/) (Version 2, April 2025)
- Google DeepMind's Frontier Safety Framework
- [Anthropic's Responsible Scaling Policy](https://www.anthropic.com/rsp-updates) (Version 2.2, May 2025)

Third-party evaluators (UK AISI, US AISI, Apollo Research, [METR](https://metr.org/)) also conduct pre-deployment assessments, though their access and time are limited. [METR's analysis of 12 companies](https://metr.org/blog/2025-12-09-common-elements-of-frontier-ai-safety-policies/) with published frontier AI safety policies found variable commitment levels.
...
In just [25 days, four major AI companies launched their most powerful models](https://vertu.com/lifestyle/the-ai-model-race-reaches-singularity-speed/):
...
This concentration represented "a compression of innovation never before seen in technology history." OpenAI's Sam Altman [issued an internal "code red" memo](https://techcrunch.com/2025/12/11/openai-fires-back-at-google-with-gpt-5-2-after-code-red-memo/) after Gemini 3 topped leaderboards, with internal sources reporting that some employees asked for delays but "competitive pressure forced the accelerated timeline."
...
[Epoch AI research from October 2025](https://epoch.ai/data-insights/open-weights-vs-closed-weights-models) found:
...
**May 2024 - [Superalignment Team Dissolution](https://www.cnbc.com/2024/05/17/openai-superalignment-sutskever-leike.html):**

...
|-------------------|---------------|
| Full argument (P1-P6) | [Rapid AI Takeover](/knowledge-base/parameters/critical-outcomes/ai-takeover-fast/) |
| P3 focus | [Alignment Robustness](/knowledge-base/parameters/alignment-robustness/) parameter |
| P4 focus | [Power-Seeking Conditions](/knowledge-base/models/power-seeking-conditions/) model |
| P2 dynamics | [Racing Intensity](/knowledge-base/parameters/racing-intensity/) parameter |
...
| P2 (Incentives) | [Threat Environment](/knowledge-base/parameters/aggregates/threat-environment/) |
| P3 (Alignment) | [Technical Safety](/knowledge-base/parameters/aggregates/technical-safety/) |
| P4 (Power-Seeking) | [Technical Safety](/knowledge-base/parameters/aggregates/technical-safety/) |
| P5 (Scaling) | [Governance Capacity](/knowledge-base/parameters/aggregates/governance-capacity/) |
...
1. **Doesn't cover all risks**: Focuses on power-seeking; doesn't address [catastrophic misuse](/knowledge-base/critical-issues/catastrophic-misuse/) or [gradual disempowerment](/knowledge-base/parameters/critical-outcomes/ai-takeover-gradual/)
...
### Critical Outcomes
- [Rapid AI Takeover](/knowledge-base/parameters/critical-outcomes/ai-takeover-fast/) — The scenario this argument addresses
- [Gradual AI Takeover](/knowledge-base/parameters/critical-outcomes/ai-takeover-gradual/) — Alternative pathway not fully covered

...
| Expert forecasting | Weak | High disagreement, reference class issues | <R id="3b9fda03b8be71dc">AI Impacts surveys</R> |
...
|----------|-------------------------|--------------|------------|
| High concern | 15-30% | Instrumental convergence makes deception likely | <R id="a2615513dd46b36c">Joe Carlsmith</R>, [MIRI](/knowledge-base/organizations/safety-orgs/miri/) |
...
- **[Alignment difficulty](/knowledge-base/debates/formal-arguments/why-alignment-hard/):** Fundamental challenges affecting $P(G)$

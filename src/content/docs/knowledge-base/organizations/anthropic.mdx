...
<InfoBox
  ...
  headcount="~1,000 (as of 2024)"
  funding="$7.3B+ (Amazon, Google, others)"
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      category="people"
      title="Dario Amodei"
      description="Anthropic CEO and co-founder"
    />
    <EntityCard
      id="chris-olah"
      category="people"
      title="Chris Olah"
      description="Interpretability pioneer and Anthropic co-founder"
    />
    <EntityCard
      id="jan-leike"
      category="people"
      title="Jan Leike"
      description="Head of Alignment at Anthropic, formerly OpenAI"
    />
    <EntityCard
      id="openai"
      category="organizations"
      title="OpenAI"
      description="Organization where Anthropic founders previously worked"
    />
    <EntityCard
      id="interpretability"
      category="safety-approaches"
      title="Mechanistic Interpretability"
      description="Key research focus for Anthropic"
    />
    <EntityCard
      id="scalable-oversight"
      category="safety-approaches"
      title="Scalable Oversight"
      description="Research on supervising superhuman AI"
    />
    <EntityCard
      id="deceptive-alignment"
      category="risks"
      title="Deceptive Alignment"
      description="Risk studied in Anthropic's sleeper agents research"
    />
    <EntityCard
      id="racing-dynamics"
      category="risks"
      title="Racing Dynamics"
      description="Competitive pressure that affects Anthropic's strategy"
    />
  </EntityCards>
</Section>
...
<Sources sources={[
  ...
  { title: "Sleeper Agents Paper", url: "https://arxiv.org/abs/2401.05566" },
  { title: "Many-Shot Jailbreaking Paper", url: "https://www-cdn.anthropic.com/af5633c94ed2beb282f6a53c595eb437e8e7b630/Many_Shot_Jailbreaking__2024_04_02_0936.pdf" },
  { title: "Machines of Loving Grace (Dario Amodei essay)", url: "https://darioamodei.com/machines-of-loving-grace" },
  { title: "Anthropic Funding News (Crunchbase)", url: "https://www.crunchbase.com/organization/anthropic" },
  { title: "Amazon Anthropic Partnership", url: "https://press.aboutamazon.com/2023/9/amazon-and-anthropic-announce-strategic-collaboration" },
  { title: "Google Anthropic Investment", url: "https://blog.google/technology/ai/google-anthropic-investment/" }
]} />

...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      description="ARC founder and alignment researcher"
    />
    <EntityCard
      id="scalable-oversight"
      category="safety-approaches"
      title="Scalable Oversight"
      description="Key ARC research area"
    />
    <EntityCard
      id="deceptive-alignment"
      category="risks"
      title="Deceptive Alignment"
      description="Risk ARC's worst-case approach addresses"
    />
    <EntityCard
      id="sandbagging"
      category="risks"
      title="Sandbagging"
      description="AI hiding capabilities during evaluations"
    />
    <EntityCard
      id="anthropic"
      category="organizations"
      title="Anthropic"
      description="Lab that ARC evaluates"
    />
    <EntityCard
      id="openai"
      category="organizations"
      title="OpenAI"
      description="Paul's former employer, lab ARC evaluates"
    />
    <EntityCard
      id="miri"
      category="organizations"
      title="MIRI"
      description="Earlier safety org with related concerns"
    />
    <EntityCard
      id="uk-aisi"
      category="policies"
      title="UK AISI"
      description="Government evaluation body inspired partly by ARC"
    />
  </EntityCards>
</Section>
...
<Sources sources={[
  ...
  { title: "GPT-4 Evaluation (ARC summary)", url: "https://evals.alignment.org/blog/2023-03-18-update-on-recent-evals/" },
  { title: "Paul Christiano's AI Alignment Forum posts", url: "https://www.alignmentforum.org/users/paulfchristiano" },
  { title: "Iterated Amplification", url: "https://ai-alignment.com/iterated-distillation-and-amplification-157debfd1616" },
  { title: "AI Safety via Debate", url: "https://arxiv.org/abs/1805.00899" },
  { title: "Ajeya Cotra's Bio Anchors", url: "https://www.alignmentforum.org/posts/KrJfoZzpSDpnrv9va/draft-report-on-ai-timelines" }
]} />

...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      category="people"
      title="Dan Hendrycks"
      description="FAR AI co-founder and director"
    />
    <EntityCard
      id="adversarial-robustness"
      category="safety-approaches"
      title="Adversarial Robustness"
      description="Core FAR AI research area"
    />
    <EntityCard
      id="natural-abstractions"
      category="concepts"
      title="Natural Abstractions"
      description="Theoretical research area"
    />
    <EntityCard
      id="benchmarking"
      category="safety-approaches"
    ...
    <EntityCard
      ...
      description="Related safety research organization"
    />
  </EntityCards>
</Section>

<Sources sources={[
  { title: "FAR AI Website", url: "https://far.ai" },
  { title: "Dan Hendrycks Google Scholar", url: "https://scholar.google.com/citations?user=VUnTdTkAAAAJ" },
  { title: "MMLU Paper", url: "https://arxiv.org/abs/2009.03300" },
  { title: "Natural Abstractions Research", url: "https://www.alignmentforum.org/tag/natural-abstraction" },
  { title: "Dan Hendrycks on X-risk", url: "https://arxiv.org/abs/2306.12001" }
]} />

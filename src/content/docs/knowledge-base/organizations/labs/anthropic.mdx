...
<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="AI safety company founded in 2021 by former OpenAI researchers developing Claude LLM and pioneering Constitutional AI. Combines frontier capabilities with safety research through their Responsible Scaling Policy framework, mechanistic interpretability work, and focus on building safe, beneficial AI systems. Has raised over $7B from Google, Amazon, and other investors." />

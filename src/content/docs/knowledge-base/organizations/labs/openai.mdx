...
sidebar:
  order: 2
quality: 4
llmSummary: Comprehensive analysis of OpenAI's transformation from 2015 non-profit to commercialized AGI leader, covering technical breakthroughs (GPT series, RLHF), governance crises (November 2023 board coup), safety researcher exodus (Sutskever, Leike, Schulman in 2024), and mounting tensions between rapid capability advancement and alignment research priorities.
...
**Successes:**
- [RLHF development](/knowledge-base/arguments/why-alignment-easy/) - first practical alignment technique
...
- Board concerns about [racing dynamics](/knowledge-base/risk-factors/racing-dynamics/) and deployment pace
...
- [Winner-take-all dynamics](/knowledge-base/risk-factors/winner-take-all/) in AI market incentivize rapid scaling
...
|--------|------|-------------|------|
| GPT-4 System Card | Technical report | Risk assessment, red teaming results | [OpenAI](https://cdn.openai.com/papers/gpt-4-system-card.pdf) |
| Preparedness Framework | Policy document | Catastrophic risk evaluation framework | [OpenAI](https://cdn.openai.com/Preparedness_Framework_Beta.pdf) |
| Jan Leike Departure Statement | Public statement | Safety culture criticism | [X/Twitter](https://twitter.com/janleike/status/1790064963966370209) |
| Superalignment Fast Grants | Research announcement | $10M safety research program | [OpenAI](https://openai.com/blog/superalignment-fast-grants) |

### Academic Research
| Paper | Authors | Contribution | Citation |
|-------|---------|-------------|----------|
| Language Models are Few-Shot Learners | Brown et al. | GPT-3 capabilities demonstration | [arXiv](https://arxiv.org/abs/2005.14165) |
| Training language models to follow instructions | Ouyang et al. | InstructGPT/RLHF methodology | [arXiv](https://arxiv.org/abs/2203.02155) |
| Weak-to-Strong Generalization | Burns et al. | Superalignment research direction | [arXiv](https://arxiv.org/abs/2312.09390) |
| Scaling Laws for Neural Language Models | Kaplan et al. | Predictable scaling relationships | [arXiv](https://arxiv.org/abs/2001.08361) |

### News and Analysis
| Source | Type | Focus | Link |
|--------|------|-------|------|
| The Information | Industry reporting | OpenAI business and governance | [The Information](https://www.theinformation.com/) |
| Anthropic Claude Analysis | Safety perspective | Competitive dynamics assessment | [Anthropic](https://www.anthropic.com/) |
| RAND Corporation | Policy analysis | AI governance implications | [RAND](https://www.rand.org/) |
| Center for AI Safety | Safety community | Risk assessment and policy | [CAIS](https://www.safe.ai/) |

...
<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="AI research company founded in 2015 that developed ChatGPT, GPT-4, and pioneered RLHF alignment. Evolved from non-profit to capped-profit structure with $13B+ investment from Microsoft. Known for rapid capability advancement through GPT series and o-series reasoning models, but also criticized for commercialization pressures and safety researcher departures in 2024." />

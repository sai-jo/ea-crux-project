...
<InfoBox
  type="organization"
  title="MIRI"
  founded="2000 (as SIAI)"
  location="Berkeley, CA"
  headcount="~20"
  funding="~$5M/year (donations)"
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      description="MIRI co-founder and rationalist community founder"
    />
    <EntityCard
      id="nate-soares"
      category="people"
      title="Nate Soares"
      description="MIRI Executive Director"
    />
    <EntityCard
      id="paul-christiano"
      category="people"
      title="Paul Christiano"
      description="ARC founder, diverged from MIRI approach"
    />
    <EntityCard
      id="instrumental-convergence"
      category="risks"
      title="Instrumental Convergence"
      description="Key MIRI concept"
    />
    <EntityCard
      id="corrigibility-failure"
      category="risks"
      title="Corrigibility Failure"
      description="Problem MIRI has worked on extensively"
    />
    <EntityCard
      id="sharp-left-turn"
      category="risks"
      title="Sharp Left Turn"
      description="MIRI's concern about discontinuous capability jumps"
    />
    <EntityCard
      id="compute-governance"
      category="policies"
      title="Compute Governance"
      description="Governance approach MIRI now advocates"
    />
    <EntityCard
      id="arc"
      category="organizations"
      title="ARC"
      description="Paul Christiano's organization, different approach"
    />
  </EntityCards>
</Section>
...
<Sources sources={[
  ...
  { title: "MIRI 2023 Strategy Update", url: "https://intelligence.org/2023/03/09/miri-announces-new-death-with-dignity-strategy/" },
  { title: "Risks from Learned Optimization (Hubinger et al.)", url: "https://arxiv.org/abs/1906.01820" },
  { title: "Logical Induction Paper", url: "https://arxiv.org/abs/1609.03543" },
  { title: "Embedded Agency (Demski, Garrabrant)", url: "https://intelligence.org/2018/10/29/embedded-agency/" },
  { title: "LessWrong Sequences", url: "https://www.lesswrong.com/sequences" },
  { title: "Eliezer Yudkowsky TIME Op-Ed", url: "https://time.com/6266923/ai-eliezer-yudkowsky-open-letter-not-enough/" },
  { title: "Agent Foundations Research", url: "https://intelligence.org/research-guide/" },
  { title: "Facing the Intelligence Explosion (Muehlhauser)", url: "https://intelligence.org/files/IE-EI.pdf" },
  { title: "MIRI on GiveWell", url: "https://www.givewell.org/charities/machine-intelligence-research-institute" }
]} />

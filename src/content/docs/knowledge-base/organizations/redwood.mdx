...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      description="Major Redwood research area"
    />
    <EntityCard
      id="ai-control"
      category="safety-approaches"
      title="AI Control"
      description="Redwood's current primary focus"
    />
    <EntityCard
      id="scheming"
      category="risks"
      title="Scheming"
      description="Threat model for control research"
    />
    <EntityCard
      id="sandbagging"
      category="risks"
      title="Sandbagging"
      description="AI hiding capabilities - Redwood research area"
    />
    <EntityCard
      id="anthropic"
    ...
    <EntityCard
      ...
      category="organizations"
      title="ARC"
      description="Parallel organization with evaluations focus"
    />
    <EntityCard
      id="miri"
      category="organizations"
      title="MIRI"
      description="Earlier safety org with different trajectory"
    />
  </EntityCards>
</Section>
...
<Sources sources={[
  ...
  { title: "Adversarial Training for High-Stakes Safety", url: "https://arxiv.org/abs/2205.01663" },
  { title: "Redwood Research on Alignment Forum", url: "https://www.alignmentforum.org/users/redwood-research" },
  { title: "Neel Nanda's Interpretability Work", url: "https://www.neelnanda.io/mechanistic-interpretability" }
]} />

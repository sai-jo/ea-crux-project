...
<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="AI safety organization founded in 2022 focused on evaluating deceptive alignment and scheming behavior in frontier AI models. Conducts rigorous empirical research on strategic deception, sandbagging (capability hiding), and situational awareness to determine whether AI systems might pursue misaligned goals while appearing aligned during training and evaluation." />

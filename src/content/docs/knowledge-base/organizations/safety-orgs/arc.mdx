...
description: AI safety research lab focused on alignment evaluations and
  theoretical research
sidebar:
  order: 11
quality: 3
llmSummary: ARC operates two divisions - ARC Theory focusing on fundamental
  alignment problems like Eliciting Latent Knowledge (ELK), and ARC Evals
  conducting capability evaluations of frontier AI models for dangerous
  behaviors like autonomous replication and deception. The organization has
  significantly influenced AI safety through establishing rigorous evaluation
  protocols now used by major labs and advancing theoretical understanding of

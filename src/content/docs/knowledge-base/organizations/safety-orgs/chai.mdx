...
sidebar:
  order: 15
quality: 1
llmSummary: CHAI is UC Berkeley's AI alignment research center founded by Stuart
  Russell, focused on developing 'human-compatible AI' that defers to human
  preferences rather than pursuing fixed objectives. The center has contributed
  key concepts like inverse reward design and assistance games while training

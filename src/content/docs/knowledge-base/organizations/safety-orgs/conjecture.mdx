---
title: Conjecture
description: AI safety research organization focused on cognitive emulation and
  mechanistic interpretability
sidebar:
  order: 12
quality: 3
llmSummary: Comprehensive profile of Conjecture, an AI safety organization
  founded in 2021 that pursues Cognitive Emulation (CoEm) - building
  interpretable AI systems based on human cognition principles rather than
  aligning existing LLMs. The organization raised $30M+ in 2023 and focuses on
  mechanistic interpretability, though their approach contrasts with mainstream
  prosaic alignment strategies.

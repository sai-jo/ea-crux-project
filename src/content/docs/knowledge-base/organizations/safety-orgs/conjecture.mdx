...
import { DataInfoBox, EstimateBox, KeyPeople, KeyQuestions, Section , PageStatus} from '../../../../../components/wiki';

<PageStatus quality={3} lastEdited="2025-12-24" llmSummary="AI safety organization founded in 2021 by Connor Leahy pursuing Cognitive Emulation (CoEm) - building interpretable AI systems based on computational principles of human cognition rather than scaling black-box models. Based in London, combines mechanistic interpretability research with skepticism of prosaic alignment approaches. Has raised $30M+ and serves as European AI safety hub." todo="Needs more detail on published research outputs and specific technical achievements as organization matures beyond conceptual framework" />

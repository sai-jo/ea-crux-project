...
import { DataInfoBox, DisagreementMap, KeyPeople, KeyQuestions, Section , PageStatus} from '../../../../../components/wiki';

<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="AI forecasting organization founded in 2022 producing rigorous, data-driven analysis of AI progress through compute trend tracking, dataset analysis, and timeline forecasting. Maintains authoritative Parameter Database documenting training compute and costs for major models. Research on data exhaustion, algorithmic efficiency, and compute governance informs policy decisions and provides empirical foundation for AI safety ecosystem." />

---
title: Epoch AI
description: AI forecasting and research organization tracking compute trends,
  datasets, and AI progress
sidebar:
  order: 14
quality: 3
llmSummary: Epoch AI is a research organization founded in 2022 that provides
  empirical data and forecasting on AI progress, particularly tracking compute
  trends (6-month doubling time for largest models), training datasets
  (high-quality text data could be exhausted by mid-2020s), and algorithmic
  efficiency (doubling every 6-12 months). Their work serves as foundational
  data infrastructure for AI governance and policy decisions across the field.

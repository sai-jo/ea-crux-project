...
<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="Machine Intelligence Research Institute founded in 2000 by Eliezer Yudkowsky, pioneering AI existential risk research and foundational concepts like instrumental convergence and the alignment problem. Conducted agent foundations research (logical uncertainty, embedded agency, decision theory) 2014-2020, then pivoted through empirical work to current governance focus. Now advocates that technical alignment unlikely to be solved in time, recommending governance and coordination approaches." />

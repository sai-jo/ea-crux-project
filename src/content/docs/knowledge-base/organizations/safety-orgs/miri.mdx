...
| **2006-2012** | Community Building | [LessWrong Sequences](https://www.lesswrong.com/sequences), rationalist movement | Create talent pipeline and intellectual infrastructure |
...
The [LessWrong](https://www.lesswrong.com/) blog sequences (2006-2009) created the intellectual foundation for the modern AI safety field, directly influencing researchers now at [Anthropic](/knowledge-base/organizations/labs/anthropic/), [OpenAI](/knowledge-base/organizations/labs/openai/), and other major organizations.
...
|---------------|-------------|--------------|-------------|
| **Logical Uncertainty** | [Logical Inductors](https://arxiv.org/abs/1609.03543) (2016) | Major theoretical breakthrough | Unclear practical applications |
| **Embedded Agency** | [Embedded Agency sequence](https://www.alignmentforum.org/s/Rm6oQRJJmhGCcLvxh) | Conceptual progress on self-reference | No concrete solutions |
...
|----------------|-----------|-----------------|----------------|
| **Avoid Technical Careers** | Low probability of success | Early career researchers | [Public statements](https://www.alignmentforum.org/posts/j9Q8bRmwCgXRYAgcJ/miri-announces-new-death-with-dignity-strategy) |
...
- **Difficulty**: [Complexity and fragility of human values](/knowledge-base/arguments/why-alignment-hard/)
...
- **Citation**: [Garrabrant et al., "Logical Induction"](https://arxiv.org/abs/1609.03543)
...
|--------|------------------|---------------|-------------------------|
| **Eliezer Yudkowsky** | >90% | AGI by 2027+ | [International moratorium](https://time.com/6266923/ai-eliezer-yudkowsky-open-letter-not-enough/) |
| **Nate Soares** | Very high | 2027-2030 median | Career pivots away from technical work |

**Core Belief**: Current [prosaic alignment](/knowledge-base/arguments/why-alignment-hard/) approaches (RLHF, Constitutional AI) are fundamentally insufficient for superintelligence.
...
|----------|---------------|--------|
| **Technical Papers** | Logical Induction, Embedded Agency | [MIRI Papers](https://intelligence.org/all-publications/) |
| **Strategic Updates** | Death with Dignity, Recent assessments | [MIRI Blog](https://intelligence.org/blog/) |
| **Historical Context** | LessWrong Sequences, Early writings | [LessWrong](https://www.lesswrong.com/sequences) |

### External Analysis

| Source | Type | Focus |
|--------|------|--------|
| **[AI Alignment Forum](https://www.alignmentforum.org/)** | Community discussion | Technical and strategic debates |
| **[GiveWell MIRI Review](https://www.givewell.org/shallow/machine-intelligence-research-institute)** | Philanthropic assessment | Cost-effectiveness analysis |
...
|--------------|-------------|---------|
| **[Center for AI Safety](https://www.safe.ai/)** | Aligned mission, different approach | [CAIS](https://www.safe.ai/) |
| **[Future of Humanity Institute](https://www.fhi.ox.ac.uk/)** | Historical collaboration (now closed) | Oxford archive |
| **[Anthropic](/knowledge-base/organizations/labs/anthropic/)** | Intellectual influence, strategic divergence | [Anthropic](https://www.anthropic.com/) |

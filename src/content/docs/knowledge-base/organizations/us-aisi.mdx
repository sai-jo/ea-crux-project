...
<InfoBox
  ...
  title="US AI Safety Institute"
  founded="2023"
  location="Washington, DC / Gaithersburg, MD"
  headcount="~50-100 (growing)"
  funding="US Federal Budget (NIST)"
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      description="International partner and collaborator"
    />
    <EntityCard
      id="metr"
      category="organizations"
      title="METR"
      description="Private evaluation org AISI learns from"
    />
    <EntityCard
      id="apollo-research"
      category="organizations"
      title="Apollo Research"
      description="Safety research organization"
    />
    <EntityCard
      id="compute-governance"
      category="policies"
      title="Compute Governance"
      description="Policy area AISI works on"
    />
    <EntityCard
      id="ai-executive-order"
      category="policies"
      title="AI Executive Order"
      description="Created US AISI mandate"
    />
    <EntityCard
      id="anthropic"
      category="organizations"
      title="Anthropic"
      description="Lab engaging with AISI"
    />
    <EntityCard
      id="openai"
      category="organizations"
...
<Sources sources={[
  { title: "US AI Safety Institute Website", url: "https://www.nist.gov/aisi" },
  { title: "NIST AI Risk Management Framework", url: "https://www.nist.gov/itl/ai-risk-management-framework" },
  { title: "Executive Order on AI (October 2023)", url: "https://www.whitehouse.gov/briefing-room/presidential-actions/2023/10/30/executive-order-on-the-safe-secure-and-trustworthy-development-and-use-of-artificial-intelligence/" },
  { title: "NIST AI Portal", url: "https://www.nist.gov/artificial-intelligence" },
  { title: "US AISI Announcements", url: "https://www.commerce.gov/news/press-releases/2023/11/biden-harris-administration-announces-key-ai-actions-following-president" }
]} />

...
<InfoBox
  ...
  headcount="~100+ (rapidly growing)"
  funding="Billions (Elon Musk, investors)"
  website="https://x.ai"
/>
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      category="people"
      title="Elon Musk"
      description="xAI founder and CEO"
    />
    <EntityCard
      id="openai"
      category="organizations"
      title="OpenAI"
      description="Musk co-founded, now competitor"
    />
    <EntityCard
      id="anthropic"
      category="organizations"
      title="Anthropic"
      description="Competitor with different safety approach"
    />
    <EntityCard
      id="racing-dynamics"
      category="risks"
      title="Racing Dynamics"
      description="xAI contributes to AI race"
    />
    <EntityCard
      id="content-moderation"
      category="concepts"
      title="Content Moderation"
      description="Central to xAI's positioning"
    />
    <EntityCard
      id="agi-race"
      category="concepts"
      title="AGI Race"
      description="Competitive dynamics xAI participates in"
    />
  </EntityCards>
</Section>

<Sources sources={[
  { title: "xAI Website", url: "https://x.ai" },
  { title: "Grok Announcements", url: "https://x.ai/blog" },
  { title: "Elon Musk on X (Twitter)", url: "https://twitter.com/elonmusk" },
  { title: "xAI Funding Announcements", url: "Various news sources" },
  { title: "Grok Technical Details", url: "https://x.ai/blog/grok" }
]} />

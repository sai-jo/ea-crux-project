...
|-----------|---------------|-------|--------|
| Cloud infrastructure | 3 firms (AWS, Azure, GCP) control 68-70% | Stable-High | [McKinsey 2024](https://www.mckinsey.com/industries/technology-media-and-telecommunications/our-insights/the-next-big-shifts-in-ai-workloads-and-hyperscaler-strategies) |
| AI training chips | NVIDIA has 80-95% market share | Stable | [DOJ Investigation 2024](https://www.debevoisedatablog.com/2024/06/20/navigating-antitrust-in-the-age-of-ai-global-regulatory-scrutiny-and-implications/) |
| Manufacturing concentration | TSMC ~90% of AI chip production; single supplier (ASML) for equipment | Very High | [AI Supply Chain Analysis 2024](https://link.springer.com/article/10.1007/s00146-025-02625-y) |
...
| Data center investment needed | \$5.2 trillion by 2030 (70% by hyperscalers) | Massive growth | [McKinsey 2024](https://www.mckinsey.com/industries/technology-media-and-telecommunications/our-insights/the-cost-of-compute-a-7-trillion-dollar-race-to-scale-data-centers) |
...
|------------|--------|-------------|--------|
| Microsoft → OpenAI | \$13B+ | Largest private AI partnership; under [regulatory scrutiny](https://www.debevoisedatablog.com/2024/06/20/navigating-antitrust-in-the-age-of-ai-global-regulatory-scrutiny-and-implications/) | Active |
...
| Big Tech AI acquisitions | \$30B+ total (2020-2024) | Potential [regulatory circumvention](https://www.pymnts.com/news/artificial-intelligence/2024/ai-antitrust-fears-big-tech-states-ramp-up-regulation-push/) via "partnerships" | Under investigation |
...
| **Regulatory capture** | AI companies influence their own regulation through lobbying, personnel rotation | High | [\$30B in acquisitions](https://www.pymnts.com/news/artificial-intelligence/2024/ai-antitrust-fears-big-tech-states-ramp-up-regulation-push/), heavy lobbying presence at AI summits |
...
|--------------|-----------|--------|-----------------|
| **Antitrust action** | Break up vertical integration, block anticompetitive mergers | [FTC/DOJ investigations ongoing](https://www.debevoisedatablog.com/2024/06/20/navigating-antitrust-in-the-age-of-ai-global-regulatory-scrutiny-and-implications/) into Microsoft-OpenAI, NVIDIA practices | Could reduce concentration by 10-20% if enforced |
| **State-level AI regulation** | Nearly [700 AI bills introduced in 2024](https://www.pymnts.com/news/artificial-intelligence/2024/ai-antitrust-fears-big-tech-states-ramp-up-regulation-push/) (400% increase from 2023); 113 enacted | Active—Colorado first comprehensive law | Creates compliance costs favoring large actors (paradoxically concentrating) |
...
| **EU AI Act** | First comprehensive legal framework, [adopted June 2024](https://www.quinnemanuel.com/the-firm/publications/artificial-intelligence-eu-regulation-and-competition-law-enforcement-addressing-emerging-challenges/) | Implementation ongoing | Compliance costs may favor large firms; transparency requirements may distribute info |
...
**Correction capacity** shows similar complexity. Distributed power (20-50 actors) creates more chances to catch and correct mistakes through diverse approaches and external scrutiny. However, it also creates more chances for any single actor to deploy dangerous systems, as demonstrated by open-source releases that bypass safety review. The [Frontier Model Forum](https://www.frontiermodelforum.org/updates/progress-update-advancing-frontier-ai-safety-in-2024-and-beyond/) attempts to balance this by sharing safety research among major labs while maintaining competitive development.
...
- Enables academic research and small-company innovation: [Carnegie Mellon 2024 course](https://medium.com/@justjlee/the-rise-of-open-source-ai-models-2024-2025-11354a0e8e23) had students build mini-GPT by training open models
- Creates competitive pressure on closed models, potentially checking monopolistic behavior
- [Chatham House 2024 analysis](https://www.chathamhouse.org/2024/06/artificial-intelligence-and-challenge-global-governance/05-open-source-and-democratization): "Open-source models signal the possibility of democratizing and decentralizing AI development... a different trajectory than centralization through proprietary solutions"
...
- [2024 research on AI democratization](https://arxiv.org/html/2409.17876v1) shows "AI democratisation" remains ambiguous, encompassing variety of goals and methods with unclear outcomes
...
- [AI infrastructure analysis 2024](https://openfuture.eu/publication/democratizing-ai-for-the-public-good/): Despite increased "open-washing," the AI infrastructure stack remains highly skewed toward closed research and limited transparency
...
This debate intersects directly with [coordination-capacity](/knowledge-base/parameters/coordination-capacity/) and [international-coordination](/knowledge-base/parameters/international-coordination/) parameters.
...
- Concentrated power invites abuse and regulatory capture—[Big Tech market concentration](https://konceptual.ai/trending/big-tech-dominance-market-disruption-analysis-2024) hasn't been seen since Standard Oil
...
- [G7 2024 statement](https://www.concurrences.com/en/review/issues/no-2-2024/on-topic/artificial-intelligence-and-antitrust): Competition authorities identify concentrated control of chips, compute, cloud capacity, and data as primary anticompetitive concern
...
- Safety standards require cooperation—[Frontier Model Forum](https://www.frontiermodelforum.org/updates/progress-update-advancing-frontier-ai-safety-in-2024-and-beyond/) shows coordination working among concentrated actors
- Racing dynamics create risks at any distribution level; more actors can mean more racing pressure, not less
- [China's parallel safety commitments](https://ai-frontiers.org/articles/is-china-serious-about-ai-safety) (17 companies, December 2024) suggest international coordination feasible with moderate concentration
...
### Related Parameters
- [Coordination Capacity](/knowledge-base/parameters/coordination-capacity/) — How effectively actors coordinate on AI governance; directly shaped by power distribution
- [International Coordination](/knowledge-base/parameters/international-coordination/) — Global coordination capacity; affected by geopolitical power distribution
- [Societal Trust](/knowledge-base/parameters/societal-trust/) — Public trust in AI institutions; undermined by concentration without accountability
- [Human Agency](/knowledge-base/parameters/human-agency/) — Individual autonomy in AI systems; reduced by concentrated algorithmic control
...
- McKinsey (2024): [The Cost of Compute: A \$7 Trillion Race to Scale Data Centers](https://www.mckinsey.com/industries/technology-media-and-telecommunications/our-insights/the-cost-of-compute-a-7-trillion-dollar-race-to-scale-data-centers)
- McKinsey (2024): [The State of AI in 2025: Agents, Innovation, and Transformation](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai)
- Konceptual AI (2024): [Big Tech Dominance: Market Disruption Analysis 2024](https://konceptual.ai/trending/big-tech-dominance-market-disruption-analysis-2024)
...
- Debevoise Data Blog (2024): [Navigating Antitrust in the Age of AI: Global Regulatory Scrutiny](https://www.debevoisedatablog.com/2024/06/20/navigating-antitrust-in-the-age-of-ai-global-regulatory-scrutiny-and-implications/)
- PYMNTS (2024): [Antitrust Fears for Big Tech as States Ramp Up Regulations](https://www.pymnts.com/news/artificial-intelligence/2024/ai-antitrust-fears-big-tech-states-ramp-up-regulation-push/)
- Quinn Emanuel (2024): [EU Regulation and Competition Law Enforcement](https://www.quinnemanuel.com/the-firm/publications/artificial-intelligence-eu-regulation-and-competition-law-enforcement-addressing-emerging-challenges/)
- Concurrences (2024): [Artificial Intelligence and Antitrust](https://www.concurrences.com/en/review/issues/no-2-2024/on-topic/artificial-intelligence-and-antitrust)
- Stanford CodeX (2024): [TRACK AI: Exploring Governance Gaps in AI Firms](https://law.stanford.edu/2024/10/04/track-ai-transparency-regulation-antitrust-contracts-knowledge-exploring-governance-gaps-in-ai-firms/)

### AI Safety Coordination (2024)
- UK Government (2024): [Frontier AI Safety Commitments, AI Seoul Summit](https://www.gov.uk/government/publications/frontier-ai-safety-commitments-ai-seoul-summit-2024/frontier-ai-safety-commitments-ai-seoul-summit-2024)
- Frontier Model Forum (2024): [Progress Update: Advancing Frontier AI Safety](https://www.frontiermodelforum.org/updates/progress-update-advancing-frontier-ai-safety-in-2024-and-beyond/)
...
- AI Frontiers (2024): [Is China Serious About AI Safety?](https://ai-frontiers.org/articles/is-china-serious-about-ai-safety)

### Open Source and Democratization (2024)
- Chatham House (2024): [Open Source and the Democratization of AI](https://www.chathamhouse.org/2024/06/artificial-intelligence-and-challenge-global-governance/05-open-source-and-democratization)
- arXiv (2024): [Why Companies "Democratise" AI: The Case of Open Source Software Donations](https://arxiv.org/html/2409.17876v1)
- Open Future (2024): [Democratizing AI for the Public Good](https://openfuture.eu/publication/democratizing-ai-for-the-public-good/)
- Medium (2025): [The Rise of Open-Source AI Models (2024-2025)](https://medium.com/@justjlee/the-rise-of-open-source-ai-models-2024-2025-11354a0e8e23)

### Infrastructure and Supply Chain (2024)
- Springer (2025): [The Politics of Artificial Intelligence Supply Chains](https://link.springer.com/article/10.1007/s00146-025-02625-y)
- Institute for Progress (2024): [How to Build the Future of AI in the United States](https://ifp.org/future-of-ai-compute/)
- AI Infrastructure Alliance (2024): [The State of AI Infrastructure at Scale 2024](https://ai-infrastructure.org/the-state-of-ai-infrastructure-at-scale-2024/)

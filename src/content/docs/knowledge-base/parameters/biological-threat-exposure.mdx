...
Biological Threat Exposure measures society's capacity to prevent, detect, and respond to biological threats—including AI-enabled bioweapon development. As a **key parameter**, it can strengthen or weaken based on technological investment, governance frameworks, and the offense-defense balance.

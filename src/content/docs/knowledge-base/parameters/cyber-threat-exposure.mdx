...
Cyber Threat Exposure measures society's ability to protect critical infrastructure and systems from cyber attacks—including AI-enabled threats. As a **key parameter**, it can strengthen or weaken based on technological investment, workforce development, and the offense-defense balance. The parameter is currently under severe strain: global AI-driven cyberattacks are projected to surpass 28 million incidents in 2025 (a 72% year-over-year increase), while the cybersecurity workforce gap has reached a record 4.8 million unfilled positions—requiring an 87% increase to meet demand.

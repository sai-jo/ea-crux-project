...
Epistemic Health measures society's collective ability to distinguish truth from falsehood and form shared beliefs about fundamental aspects of reality. As a **key parameter**, it can increase or decrease based on various factors—including AI development and deployment.
...
The [2025 Edelman Trust Barometer](https://www.edelman.com/trust/2025/trust-barometer) (surveying 32,000+ respondents across 28 countries) reveals acute institutional trust erosion. Those with high grievance levels distrust all four major institutions—business, government, media, and NGOs—with 40% approving hostile activism including spreading disinformation or threatening violence. Only 36% believe things will improve for the next generation (just 20% in developed countries). [Pew Research](https://www.pewresearch.org/short-reads/2025/10/29/how-americans-trust-in-information-from-news-organizations-and-social-media-sites-has-changed-over-time/) finds trust in national news organizations dropped from 76% (2016) to 56% (September 2025)—an 11-point decline in six months alone.

| Institution | Peak Trust | Current (2024-25) | Trend | Source |
|-------------|------------|-------------------|-------|--------|
| Mass media | 72% (1970s) | 28% | Historic low | Edelman 2024 |
| National news organizations (US) | 76% (2016) | 56% (Sept 2025) | -20 points | Pew Research |
| "No trust at all" in media | &lt;10% | 36-38% | Rising | Edelman 2024 |
| Worry about distinguishing real from fake | -- | 59% globally | Rising | Various |
| Belief democracy at risk of failure (US) | -- | 64% | Rising | NPR/Brookings 2024 |
...
### Related Parameters
- [Societal Trust](/knowledge-base/parameters/societal-trust/) — Broader parameter encompassing institutional and interpersonal trust
- [Information Authenticity](/knowledge-base/parameters/information-authenticity/) — Technical capacity to verify content provenance
- [Reality Coherence](/knowledge-base/parameters/reality-coherence/) — Degree of shared understanding of fundamental reality
- [Human Agency](/knowledge-base/parameters/human-agency/) — Human capacity for autonomous decision-making (requires epistemic foundation)
- [Institutional Quality](/knowledge-base/parameters/institutional-quality/) — Institutional capacity depends on epistemic commons
- [Regulatory Capacity](/knowledge-base/parameters/regulatory-capacity/) — Effective regulation requires accurate information assessment

### Related Risks
- [Epistemic Collapse](/knowledge-base/risks/epistemic/epistemic-collapse/) — Describes catastrophic loss of this parameter
- [Trust Erosion](/knowledge-base/risks/epistemic/trust-erosion/) — Gradual degradation of institutional trust
- [Sycophancy at Scale](/knowledge-base/risks/epistemic/sycophancy-scale/) — AI systems reinforcing user biases

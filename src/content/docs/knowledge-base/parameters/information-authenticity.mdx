...
Information Authenticity measures the degree to which content circulating in society can be verified as genuine—tracing to real events, actual sources, or verified creators rather than synthetic fabrication. As a **key parameter**, it can increase or decrease based on various factors—including AI development and deployment.
...
- [Trust Erosion](/knowledge-base/risks/epistemic/trust-erosion/) — Declining confidence in institutions and verification systems

...
Institutional Quality measures the health and effectiveness of institutions involved in AI governance—their independence from capture, ability to retain expertise, and quality of decision-making processes. While regulatory capacity asks whether governments *can* regulate, institutional quality asks whether they will do so in the public interest rather than serving narrow constituencies.

As a **key parameter**, institutional quality can increase or decrease based on funding structures, personnel practices, transparency norms, and the balance of power between regulated industries and oversight bodies. High quality enables governance that genuinely serves public interest; low quality results in capture where institutions nominally serving the public actually advance industry interests.
...
flowchart TD
    subgraph CAPTURE["Capture Dynamics"]
        CAP1[Resource asymmetry 600:1]
        CAP2[Revolving door personnel]
        CAP3[Information dependence on industry]
    end

    subgraph POLITICAL["Political Pressures"]
        POL1[Administration changes reverse policy]
        POL2[Innovation vs. safety framing]
        POL3[Industry lobbying campaigns]
    end

    subgraph STRUCTURAL["Structural Weaknesses"]
        STR1[Expertise gaps]
        STR2[Slow institutional processes]
        STR3[Fragmented oversight]
    end
...
### Related Parameters
- [Regulatory Capacity](/knowledge-base/parameters/regulatory-capacity/) — Capacity enables quality; quality without capacity is insufficient
- [International Coordination](/knowledge-base/parameters/international-coordination/) — International frameworks can reinforce domestic quality
- [Safety Culture Strength](/knowledge-base/parameters/safety-culture-strength/) — Internal institutional culture affects resistance to capture
- [Epistemic Health](/knowledge-base/parameters/epistemic-health/) — Ability to evaluate complex AI claims affects institutional independence
- [Societal Trust](/knowledge-base/parameters/societal-trust/) — Public trust enables institutional legitimacy
- [Human Agency](/knowledge-base/parameters/human-agency/) — Institutional quality affects ability to maintain human control

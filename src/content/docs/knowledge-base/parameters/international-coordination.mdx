...
International Coordination measures the degree of global cooperation on AI governance and safety across nations and institutions. This parameter tracks treaty participation, shared standards adoption, institutional network strength, and the quality of bilateral and multilateral dialogues on AI risks. Unlike purely domestic governance capacity, international coordination captures the ability of the global community to collectively address risks that transcend national boundaries.

As a **key parameter**, international coordination can increase or decrease based on various factors—including geopolitical dynamics, AI development trajectories, and the occurrence of near-miss incidents that might motivate cooperation. High coordination enables shared safety standards that prevent racing to the bottom; low coordination risks regulatory fragmentation and competitive dynamics that undermine safety.
...
- [International Coordination Overview](/knowledge-base/responses/governance/international/international/) — Detailed analysis of coordination mechanisms
...
### Related Parameters
- [Regulatory Capacity](/knowledge-base/parameters/regulatory-capacity/) — Domestic capacity enables international engagement
- [Institutional Quality](/knowledge-base/parameters/institutional-quality/) — Healthy institutions required for sustained coordination
- [Societal Trust](/knowledge-base/parameters/societal-trust/) — Public confidence affects compliance with international frameworks
- [Human Agency](/knowledge-base/parameters/human-agency/) — Coordination must preserve meaningful human control over AI systems

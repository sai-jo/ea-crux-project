...
Preference Authenticity measures the degree to which human preferences—what people want, value, and pursue—reflect genuine internal values rather than externally shaped desires. As a **key parameter**, it can increase or decrease based on various factors—including AI development and deployment.
...
However, individual-level solutions face inherent limitations against systemic optimization:
...
| **Mindful technology use** | Intentional, purposeful engagement | Requires sustained discipline |
...
|----------|-------------|---------|-------------|
| **Authenticity Preserved** | 15-25% | Regulation and norms protect preference formation | Strong policy response; technical standards; cultural resistance |
| **Managed Erosion** | 35-45% | Partial protections; some domains protected | Sector-specific regulation; opt-in/opt-out systems; transparency requirements |
| **Preference Capture** | 25-35% | AI systems routinely shape human preferences | Weak enforcement; commercial pressure; user habituation |
| **Value Lock-in** | 5-10% | Preferences permanently optimized for AI system goals | Advanced AI capabilities; lack of regulatory response; feedback loops |
...
- [Sycophancy at Scale](/knowledge-base/risks/epistemic/sycophancy-scale/) — AI systems reinforcing existing preferences
...
- [Trust Erosion](/knowledge-base/risks/epistemic/trust-erosion/) — Loss of trust in own judgments
...
### Related Parameters
- [Human Agency](/knowledge-base/parameters/human-agency/) — Capacity for autonomous action
...
- [Information Authenticity](/knowledge-base/parameters/information-authenticity/) — Content verification capability
- [Societal Trust](/knowledge-base/parameters/societal-trust/) — Trust in institutions and information
- [Human Expertise](/knowledge-base/parameters/human-expertise/) — Independent judgment capacity
- [Human Oversight Quality](/knowledge-base/parameters/human-oversight-quality/) — Ability to review AI influence

...
flowchart TD
    subgraph STRUCTURAL["Structural Barriers"]
        STR1[600:1 Resource disparity]
        STR2[Talent pipeline to industry]
        STR3[Capability gap widening]
    end

    subgraph POLITICAL["Political Volatility"]
        POL1[Administration changes]
        POL2[Innovation vs. safety framing]
        POL3[Budget constraints]
    end

    subgraph TECHNICAL["Technical Challenges"]
        TECH1[Model opacity]
        TECH2[Rapid capability advances]
        TECH3[Dual-use nature]
    end

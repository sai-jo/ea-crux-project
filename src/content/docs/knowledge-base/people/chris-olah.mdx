...
<InfoBox
  ...
  knownFor="Mechanistic interpretability, neural network visualization, clarity of research communication"
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      category="lab"
      title="Anthropic"
      description="AI safety company co-founded by Chris Olah"
    />
    <EntityCard
      id="interpretability"
      category="safety-agenda"
      title="Interpretability"
      description="Research area pioneered by Olah"
    />
    <EntityCard
      id="dario-amodei"
      category="researcher"
...
<Sources sources={[
  { title: "Chris Olah's Blog", url: "https://colah.github.io" },
  { title: "Distill Journal", url: "https://distill.pub" },
  { title: "Anthropic Interpretability Research", url: "https://www.anthropic.com/research#interpretability" },

...
<InfoBox
  ...
  role="CEO & Co-founder"
  knownFor="Founding Conjecture, AI safety advocacy, interpretability research"
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      description="Core research focus at Conjecture"
    />
    <EntityCard
      id="chris-olah"
      category="researcher"
      title="Chris Olah"
      description="Pioneer in interpretability research"
    />
    <EntityCard
      id="neel-nanda"
      category="researcher"
      title="Neel Nanda"
      description="Fellow interpretability researcher"
    />
  </EntityCards>
</Section>

<Sources sources={[
  { title: "Conjecture", url: "https://conjecture.dev" },
  { title: "Connor Leahy on Twitter/X", url: "https://twitter.com/ConnorLeahy" },
  { title: "Various podcast appearances", url: "https://www.youtube.com/results?search_query=connor+leahy" },
]} />

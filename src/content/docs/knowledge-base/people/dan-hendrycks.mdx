...
<InfoBox
  type="researcher"
  title="Dan Hendrycks"
  affiliation="Center for AI Safety (CAIS)"
  role="Director"
  knownFor="AI safety research, benchmark creation, CAIS leadership, catastrophic risk focus"
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      category="lab"
      title="CAIS"
      description="Center for AI Safety, directed by Dan Hendrycks"
    />
    <EntityCard
      id="compute-governance"
      category="policy"
      title="Compute Governance"
      description="Policy area CAIS works on"
    />
    <EntityCard
      id="yoshua-bengio"
      category="researcher"
      title="Yoshua Bengio"
      description="Prominent signatory of Statement on AI Risk"
    />
  </EntityCards>
</Section>

<Sources sources={[
  { title: "Dan Hendrycks' Website", url: "https://hendrycks.com" },
  { title: "Center for AI Safety", url: "https://safe.ai" },
  { title: "Statement on AI Risk", url: "https://safe.ai/statement-on-ai-risk" },
  { title: "Google Scholar Profile", url: "https://scholar.google.com/citations?user=VEvOFxQAAAAJ" },
]} />

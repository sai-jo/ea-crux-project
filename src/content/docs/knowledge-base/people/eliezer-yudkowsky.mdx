...
import {DataInfoBox, Section, DisagreementMap, Backlinks, PageStatus} from '../../../../components/wiki';

<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="Co-founder of MIRI and pioneer of AI safety research since the late 1990s, known for early problem formulation, founding the rationalist community and LessWrong, and expressing extremely high probability of AI-caused extinction without major breakthroughs." />

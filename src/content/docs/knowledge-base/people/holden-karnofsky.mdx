...
Holden Karnofsky is co-CEO of [Open Philanthropy](https://www.openphilanthropy.org/), the most influential grantmaker in AI safety and existential risk. Through Open Phil, he has directed over $300 million toward AI safety research and governance, fundamentally transforming it from a fringe academic interest into a well-funded field with hundreds of researchers.

His strategic thinking has shaped how the effective altruism community prioritizes AI risk through frameworks like the ["Most Important Century"](https://www.cold-takes.com/most-important-century/) thesis. This argues we may live in the century that determines humanity's entire future trajectory due to transformative AI development.
...
|---------------|----------------------|----------|----------|
| Transformative AI | ~15% by 2036, ~50% by 2060 | [Bio anchors framework](https://www.cold-takes.com/forecasting-transformative-ai-the-biological-anchors-method-in-a-nutshell/) | This century |
...
|--------|------|------------------|
| 2007-2011 | Co-founder, [GiveWell](https://www.givewell.org/) | Pioneered rigorous charity evaluation methodology |
...
- 2021: [$580M investment in Anthropic](https://www.anthropic.com/news/open-philanthropy-investment) to create safety-focused lab
- 2022: Establishment of [AI safety university programs](https://www.openphilanthropy.org/focus/potential-risks-from-advanced-artificial-intelligence/ai-safety-via-market-incentives/)
...
**Supporting evidence:**
- [Biological anchors methodology](https://www.cold-takes.com/forecasting-transformative-ai-the-biological-anchors-method-in-a-nutshell/) for AI timelines
- Historical analysis of technological transitions
- Economic modeling of AI impact potential

### Bio Anchors Framework

Developed with [Ajeya Cotra](https://www.openphilanthropy.org/about/team/ajeya-cotra/), this framework estimates AI development timelines by comparing required computation to biological systems:
...
| AI governance | $80M+ | [Center for Security and Emerging Technology](https://cset.georgetown.edu/), policy fellowships | Institutional responses to AI development |
...
- [Anthropic investment](https://www.anthropic.com/news/open-philanthropy-investment): $580M to create safety-focused competitor to OpenAI
...
| 2024 | Accelerated timelines concern | [Shorter timelines than bio anchors suggested](https://www.cold-takes.com/ai-timelines-where-the-arguments-and-the-experts-stand/) |
...
**Academic legitimacy:**
- Funding enabled [AI safety courses](https://www.aisafety.com/academic-programs) at major universities
...
- Supported research informing [EU AI Act](https://artificialintelligenceact.eu/)
...
- Others prefer [global health and development](https://www.givewell.org/) emphasis
- Debate over concentration vs. diversification of funding

**With AI safety researchers:**
- Tension between [technical alignment focus](/knowledge-base/arguments/why-alignment-hard/) and governance approaches
...
- ["The Most Important Century"](https://www.cold-takes.com/most-important-century/) series (>100k views)
- ["AI Timelines: Where the Arguments Stand"](https://www.cold-takes.com/ai-timelines-where-the-arguments-and-the-experts-stand/) (policy reference)
- ["Bio Anchors" explanation](https://www.cold-takes.com/forecasting-transformative-ai-the-biological-anchors-method-in-a-nutshell/) (research methodology)
...
|------|--------|-------------|
| Blog | [Cold Takes](https://www.cold-takes.com/) | Karnofsky's strategic thinking and analysis |
| Organization | [Open Philanthropy](https://www.openphilanthropy.org/) | Grant database and reasoning |
| Research | [Bio Anchors Report](https://www.openphilanthropy.org/research/draft-report-on-ai-timelines/) | Technical forecasting methodology |
| Testimony | [Congressional Hearing](https://www.congress.gov/) | Policy positions and recommendations |

### Secondary Analysis

| Type | Source | Focus |
|------|--------|-------|
| Academic | [EA Research](https://forum.effectivealtruism.org/) | Critical analysis of funding decisions |
| Journalistic | [MIT Technology Review](https://www.technologyreview.com/) | External perspective on influence |
| Policy | [RAND Corporation](https://www.rand.org/) | Government research on philanthropic AI funding |

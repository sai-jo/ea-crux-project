...
<InfoBox
  ...
  knownFor="Deep learning breakthroughs, OpenAI leadership, now focused on safe superintelligence"
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      category="lab"
      title="OpenAI"
      description="Ilya's former organization where he was Chief Scientist"
    />
    <EntityCard
      id="jan-leike"
      category="researcher"
      title="Jan Leike"
      description="Former colleague who also left OpenAI over safety concerns"
    />
    <EntityCard
      id="geoffrey-hinton"
      category="researcher"
      title="Geoffrey Hinton"
      description="Ilya's PhD advisor, also now focused on AI safety"
    />
  </EntityCards>
</Section>
...
<Sources sources={[
  ...
  { title: "SSI Founding Announcement", url: "https://ssi.inc/announcement" },
  { title: "AlexNet Paper", url: "https://papers.nips.cc/paper/4824-imagenet-classification-with-deep-convolutional-neural-networks" },
]} />

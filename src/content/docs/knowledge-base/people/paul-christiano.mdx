...
import {DataInfoBox, DisagreementMap, EstimateBox, Backlinks} from '../../../../components/wiki';
...
Published in ["Supervising strong learners by amplifying weak experts"](https://arxiv.org/abs/1810.08575) (2018):

| Component | Description | Status |
|-----------|-------------|--------|
| Human + AI Collaboration | Human overseer works with AI assistant on complex tasks | Tested at scale by [OpenAI](https://openai.com/research/scalable-oversight-of-ai-systems) |
...
Co-developed with [Geoffrey Irving](https://scholar.google.com/citations?user=BqAeRdAAAAAJ) at DeepMind in ["AI safety via debate"](https://arxiv.org/abs/1805.00899) (2018):

| Mechanism | Implementation | Results |
|-----------|---------------|---------|
| Adversarial Training | Two AIs argue for different positions | Deployed at [Anthropic](https://www.anthropic.com/news/constitutional-ai-harmlessness-from-ai-feedback) |
...
|---------|------------------|---------------|
| Task too complex for direct evaluation | Process-based feedback vs outcome evaluation | [Implemented at OpenAI](https://openai.com/research/training-language-models-to-follow-instructions-with-human-feedback) |
...
|-------|------|----|---------| 
| Risk assessment | ~5% P(doom) | ~10-20% P(doom) | ["What failure looks like"](https://www.alignmentforum.org/posts/HBxe6wdjxK239zajf/what-failure-looks-like) |
| Research focus | IDA/Debate | Eliciting Latent Knowledge | [ARC's ELK report](https://docs.google.com/document/d/1WwsnJQstPq91_Yh-Ch2XRL8H_EpsnjrC1dwZXR37PC8/) |
...
- **[AI Alignment Forum](https://www.alignmentforum.org/)**: Primary venue for technical alignment discourse
...
|-------------|------|-------|--------|
| [Supervising strong learners by amplifying weak experts](https://arxiv.org/abs/1810.08575) | 2018 | NeurIPS | Foundation for IDA |
| [AI safety via debate](https://arxiv.org/abs/1805.00899) | 2018 | arXiv | Debate framework |
| [What failure looks like](https://www.alignmentforum.org/posts/HBxe6wdjxK239zajf/what-failure-looks-like) | 2019 | AF | Risk assessment update |
| [Eliciting Latent Knowledge](https://docs.google.com/document/d/1WwsnJQstPq91_Yh-Ch2XRL8H_EpsnjrC1dwZXR37PC8/) | 2021 | ARC | Current research focus |

### Organizations and Links

| Category | Links |
|----------|--------|
| **Research Organization** | [Alignment Research Center](https://alignment.org/) |
| **Blog/Writing** | [AI Alignment Forum](https://www.alignmentforum.org/users/paul-christiano), [Personal blog](https://ai-alignment.com/) |
| **Academic** | [Google Scholar](https://scholar.google.com/citations?user=5swZZT4AAAAJ) |
| **Social** | [Twitter](https://twitter.com/paulfchristiano) |

### Related Research Areas

| Area | Connection to Christiano's Work |
|------|-------------------------------|
| [Scalable oversight](/knowledge-base/responses/technical/interpretability/) | Core research focus |
| [Reward modeling](/knowledge-base/responses/technical/rlhf/) | Foundation for many proposals |

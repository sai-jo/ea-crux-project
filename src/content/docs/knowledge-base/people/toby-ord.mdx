...
<InfoBox
  type="researcher"
  title="Toby Ord"
  affiliation="Future of Humanity Institute (until closure), Oxford"
  role="Senior Research Fellow in Philosophy"
  knownFor="The Precipice, existential risk quantification, effective altruism"
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      category="researcher"
      title="Nick Bostrom"
      description="Colleague at FHI, fellow existential risk researcher"
    />
    <EntityCard
      id="holden-karnofsky"
      category="researcher"
      title="Holden Karnofsky"
      description="EA leader focused on AI risk at Open Philanthropy"
    />
  </EntityCards>
</Section>

<Sources sources={[
  { title: "Toby Ord's Website", url: "https://www.tobyord.com" },
  { title: "The Precipice", url: "https://theprecipice.com/" },
  { title: "80,000 Hours Podcast", url: "https://80000hours.org/podcast/episodes/toby-ord-the-precipice-existential-risk-future-humanity/" },
  { title: "Giving What We Can", url: "https://www.givingwhatwecan.org/" },
]} />

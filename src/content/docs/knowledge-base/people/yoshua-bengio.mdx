...
<InfoBox
  ...
  knownFor="Deep learning pioneer, now AI safety advocate"
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      description="Fellow Turing Award winner also now focused on AI safety"
    />
    <EntityCard
      id="interpretability"
      category="safety-agenda"
      title="Interpretability"
      description="Research area Bengio is contributing to"
    />
  </EntityCards>
</Section>

<Sources sources={[
  { title: "Yoshua Bengio's Website", url: "https://yoshuabengio.org" },
  { title: "Mila Institute", url: "https://mila.quebec/" },
  { title: "Statement on AI Risk", url: "https://www.safe.ai/statement-on-ai-risk" },
  { title: "Google Scholar Profile", url: "https://scholar.google.com/citations?user=kukA0LcAAAAJ" },
]} />

...
<InfoBox
  ...
  title="Compute Governance"
  customFields={[
    { label: "Category", value: "Hardware-based regulation" },
    { label: "Tractability", value: "Medium-High (measurable, concentrated)" },
    { label: "Primary Researchers", value: "~10-30 dedicated researchers" },
    { label: "Policy Adoption", value: "Emerging (US EO, EU AI Act)" },
    { label: "Key Advantage", value: "Upstream intervention" },
  ]}
/>
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      description="Leading compute governance research"
    />
    <EntityCard
      id="governance-policy"
      category="intervention"
      title="AI Governance and Policy"
      description="Broader governance intervention category"
    />
  </EntityCards>
</Section>

<Sources sources={[
  { title: "Computing Power and the Governance of AI", url: "https://www.governance.ai/research-papers/computing-power-and-the-governance-of-artificial-intelligence", author: "Heim et al.", date: "2023" },
  { title: "US Export Controls on Advanced Computing", url: "https://www.bis.doc.gov/", author: "Bureau of Industry and Security" },
  { title: "EU AI Act Compute Provisions", url: "https://artificialintelligenceact.eu/" },
  { title: "CSET Semiconductor Reports", url: "https://cset.georgetown.edu/publications/?fwp_publication_types=issue-brief&fwp_topics=semiconductors" },
  { title: "The Chips and Science Act", url: "https://www.congress.gov/bill/117th-congress/house-bill/4346", date: "2022" },
]} />

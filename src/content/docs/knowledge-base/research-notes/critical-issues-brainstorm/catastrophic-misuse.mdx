...
|-----------|--------------|-----------|
| [Threat Environment](/knowledge-base/parameters/threat-environment/) | Determines who wants to cause harm | Higher threat → Higher risk |
| [Model Access Regime](/knowledge-base/parameters/model-access-regime/) | Controls who can use capable models | More open → Higher risk |
| [Governance Effectiveness](/knowledge-base/parameters/governance-effectiveness/) | Ability to prevent/respond | Lower → Higher risk |
...
| Intervention | Mechanism |
|--------------|-----------|
| [Model access controls](/knowledge-base/responses/governance/model-access/) | Limit who can use most capable models |
| [Know-your-customer for AI](/knowledge-base/responses/governance/industry/kyc/) | Accountability for API access |
| [Export controls](/knowledge-base/responses/governance/national/export-controls/) | Prevent adversary access |
| [International cooperation](/knowledge-base/responses/governance/international/) | Coordinate on dual-use restrictions |
...
- [Cyber Risks](/knowledge-base/risks/misuse/cyber/) — Specific pathway
- [AI Takeover](/knowledge-base/critical-issues/ai-takeover/) — Alternative threat model
- [Model Access Governance](/knowledge-base/responses/governance/model-access/) — Key intervention

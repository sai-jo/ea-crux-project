...
|-----------|--------------|-----------|
| [Racing Intensity](/knowledge-base/ai-transition-model/factors/transition-turbulence/racing-intensity/) | Core driver | Higher → More failure |
| [Safety-Capability Gap](/knowledge-base/ai-transition-model/factors/misalignment-potential/safety-capability-gap/) | Pressure to deploy | Wider → More failure |
| [Coordination Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/coordination-capacity/) | Ability to avoid | Weaker → More failure |
| [Regulatory Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/regulatory-capacity/) | External constraint | Lower → More failure |
...
- [AI Takeover](/knowledge-base/research-notes/critical-issues-brainstorm/ai-takeover/) — What racing leads to
- International Governance — Coordination mechanism
- [Responsible Scaling Policies](/knowledge-base/responses/governance/industry/responsible-scaling-policies/) — Industry approach
- [Multipolar Competition](/knowledge-base/scenarios/multipolar-competition/) — Detailed scenarios

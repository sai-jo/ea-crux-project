...
|-----------|--------------|-----------|
| [Human Agency](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/) | Core target | Lower → More disempowered |
| [Economic Stability](/knowledge-base/ai-transition-model/factors/transition-turbulence/economic-stability/) | Transition smoothness | Lower → More disruption |
| [Epistemic Health](/knowledge-base/ai-transition-model/factors/civilizational-competence/epistemic-health/) | Can we recognize what's happening? | Lower → Worse |
| [Societal Trust](/knowledge-base/ai-transition-model/factors/civilizational-competence/societal-trust/) | Coordination to respond | Lower → Harder to respond |
...
- [Lock-in Scenarios](/knowledge-base/research-notes/critical-issues-brainstorm/lock-in/) — Can result from disempowerment
- [AI Takeover](/knowledge-base/research-notes/critical-issues-brainstorm/ai-takeover/) — Alternative failure mode
- [Human Agency](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/) — What we're losing

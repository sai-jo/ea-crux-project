...
This brainstorming explored an alternate "Critical Issues" framing for failure modes. The main knowledge base now uses [Critical Outcomes](/knowledge-base/ai-transition-model/scenarios/) within the parameter hierarchy instead. These pages are retained as reference material showing an alternative taxonomy.
:::

## Overview

Critical Issues are **concrete failure modes** that explain how AI development could lead to catastrophic outcomes. They form the intermediate layer between [Parameters](/knowledge-base/ai-transition-model/) (what we can measure and influence) and [Outcomes](/knowledge-base/ai-transition-model/outcomes/) (what we ultimately care about).
...
The existing [Parameters](/knowledge-base/ai-transition-model/) → [Outcomes](/knowledge-base/ai-transition-model/outcomes/) hierarchy was too abstract. When we say "Technical Safety reduces Acute Risk"—*how*? Through what pathways?

...
|-----------|--------------|-----------|
| [Power Concentration](/knowledge-base/parameters/power-concentration/) | Direct enabler | Higher → Higher risk |
| [Human Agency](/knowledge-base/parameters/human-agency/) | Ability to resist | Lower → Higher risk |
| [Governance Capacity](/knowledge-base/parameters/governance-capacity/) | Checks on power | Lower → Higher risk |
| [Value Diversity](/knowledge-base/parameters/value-diversity/) | Alternatives exist | Lower → Higher risk |
...
|--------------|-----------|
| [Distribution of AI capability](/knowledge-base/responses/governance/distribution/) | Prevent monopoly on power |
| [Democratic AI governance](/knowledge-base/responses/governance/democratic-ai/) | Public control over AI development |
| [International coordination](/knowledge-base/responses/governance/international/) | Prevent unilateral dominance |
| [Preserving human agency](/knowledge-base/responses/human-agency/) | Maintain capacity to change |
...
- [Gradual Disempowerment](/knowledge-base/critical-issues/gradual-disempowerment/) — Related pathway
- [AI Takeover](/knowledge-base/critical-issues/ai-takeover/) — May lead to lock-in
- [Coordination Failure](/knowledge-base/critical-issues/coordination-failure/) — May enable lock-in
- [Democratic AI Governance](/knowledge-base/responses/governance/democratic-ai/) — Prevention approach

...
|-----------|--------------|-----------|
| [AI Control Concentration](/knowledge-base/ai-transition-model/factors/misuse-potential/ai-control-concentration/) | Direct enabler | Higher → Higher risk |
| [Human Agency](/knowledge-base/ai-transition-model/factors/civilizational-competence/human-agency/) | Ability to resist | Lower → Higher risk |
| [Governance Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/governance/) | Checks on power | Lower → Higher risk |
...
| [International coordination](/knowledge-base/ai-transition-model/factors/civilizational-competence/international-coordination/) | Prevent unilateral dominance |
...
- [Value Lock-in (Parameter)](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/values/) — Quantitative parameter

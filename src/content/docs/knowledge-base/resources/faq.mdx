...
import { InfoBox, KeyQuestions, EntityCard, EntityCards, Section, Tags, Sources, DisagreementMap } from '../../../../components/wiki';
...
**Deeper resources**:
- [Compute Governance](/knowledge-base/policies/compute-governance)
- [EU AI Act](/knowledge-base/policies/eu-ai-act)
- [UK AI Safety Institute](/knowledge-base/policies/uk-aisi)
...
**Deeper resources**:
- [Alignment Difficulty](/understanding-ai-risk/core-argument/alignment-difficulty)
- [Scalable Oversight](/knowledge-base/safety-approaches/technical/scalable-oversight)
...
**Deeper resources**:
- [Mechanistic Interpretability](/knowledge-base/safety-approaches/technical/interpretability)
...
<Section title="Related Resources">
  <EntityCards>
    <EntityCard
      id="core-argument"
      category="crux"
      title="Core Argument for AI Risk"
      description="Structured breakdown of the case for existential risk"
    />
    <EntityCard
      id="glossary"
      category="crux"
      title="Glossary"
      description="Key terms and concepts in AI safety"
    />
    <EntityCard
      id="timelines"
      category="crux"
    ...
    <EntityCard
      ...
      description="Why aligning AI is technically hard"
    />
  </EntityCards>
</Section>

...
<PageStatus quality={3} lastEdited="2025-12-24" llmSummary="Epistemic infrastructure includes the systems and institutions that enable societies to create, verify, and preserve reliable knowledge, from knowledge bases like Wikipedia to verification networks and provenance systems like C2PA. Critical gaps include cross-platform verification, real-time synthesis capabilities, and sustainable funding models for verification as a public good." todo="Expand governance section with specific organizational models and their tradeoffs; add more detail on AI integration risks and mitigation strategies" />

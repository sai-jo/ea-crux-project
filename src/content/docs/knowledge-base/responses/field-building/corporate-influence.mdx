...
import { DataInfoBox, EstimateBox, DisagreementMap, KeyQuestions , PageStatus} from '../../../../../components/wiki';

<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="Direct influence on AI labs through working at companies like Anthropic and DeepMind, shareholder activism, whistleblowing, and safety culture advocacy represents a controversial but potentially high-impact approach. While offering direct access to frontier systems and decision-making, it raises concerns about complicity in capabilities acceleration, safety washing, and perspective capture." todo="Update with latest developments post-2024; add more quantitative data on safety team sizes and influence metrics" />

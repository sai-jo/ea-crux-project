...
description: This analysis examines AI safety field-building interventions including
  education programs (ARENA, MATS, BlueDot). It finds the field grew from approximately 400 FTEs
  in 2022 to 1,100 FTEs in 2025 (21-30% annual growth), with training programs achieving
  37% career conversion rates and costs of $5,000-40,000 per career change.
sidebar:
  order: 4
quality: 5
llmSummary: Comprehensive analysis of AI safety field-building interventions
  including education programs (ARENA, MATS), funding mechanisms (~$110-130M/year
  philanthropic, ~$600M total including corporate), and community infrastructure, with cost estimates of
  $5,000-40,000 per career change depending on program intensity. Field grew from 400 FTEs (2022)
  to 1,100 FTEs (2025) at 21-30% annual growth rate. Identifies key bottleneck that
  talent pipeline is over-optimized for researchers while neglecting other roles.
lastEdited: "2025-12-28"
importance: 78.5
---

import {DataInfoBox, EstimateBox, KeyQuestions, Mermaid} from '../../../../../components/wiki';
...
|-----------|------------|----------|
| Field Size (2025) | **1,100 FTEs** (600 technical, 500 non-technical) | [AI Safety Field Growth Analysis 2025](https://forum.effectivealtruism.org/posts/7YDyziQxkWxbGmF3u/ai-safety-field-growth-analysis-2025) |
| Annual Growth Rate | **21-30%** since 2020 | Technical: 21% FTE growth; Non-technical: 30% |
| Total Philanthropic Funding | **$110-130M/year** (2024) | [Overview of AI Safety Funding](https://forum.effectivealtruism.org/posts/XdhwXppfqrpPL2YDX/an-overview-of-the-ai-safety-funding-situation) |
| Training Program Conversion | **37%** work full-time in AI safety | [BlueDot 2022 Cohort Analysis](https://blog.bluedot.org/p/2022-ai-alignment-course-impact) |
| Cost per Career Change | **$5,000-40,000** depending on program | ARENA lower-touch, MATS higher-touch |
| Key Bottleneck | Talent pipeline over-optimized for researchers | [EA Forum analysis](https://forum.effectivealtruism.org/posts/m5dDrMfHjLtMu293G/ai-safety-s-talent-pipeline-is-over-optimised-for) |
...
|---------|--------|----------|-------|------------------|----------------|--------------|
| [MATS](https://www.matsprogram.org/) | Research mentorship | 3-4 months | 30-50/cohort | ~$20,000-40,000 | 75% publish results | Alumni at Anthropic, OpenAI, DeepMind; founded Apollo Research, Timaeus |
| [ARENA](https://www.arena.education/) | In-person bootcamp | 4-5 weeks | 20-30/cohort | ~$5,000-15,000 | 8 confirmed FT positions (5.0 cohort) | Alumni at Apollo Research, METR, UK AISI |
| [BlueDot Impact](https://bluedot.org/) | Online cohort-based | 8 weeks | 1,000+/year | ~$440/student | 37% work FT in AI safety | 6,000+ trained since 2022; 75% completion rate |
| [SPAR](https://sparai.org/) | Part-time remote | Varies | 50+/cohort | Low (volunteer mentors) | Research output focused | Connects aspiring researchers with professionals |
...
- Received [$23.6M in Open Philanthropy funding](https://www.openphilanthropy.org/grants/mats-research-ai-safety-research-expenses/) for general support
...
- [ARENA 5.0](https://www.lesswrong.com/posts/XXTanE2GeP5Lchp9G/arena-5-0-impact-report): 8 participants confirmed full-time AI safety positions post-program
...
**[BlueDot Impact](https://bluedot.org/) (formerly AI Safety Fundamentals):**
- Trained 6,000+ professionals worldwide since 2022
- [2022 cohort analysis](https://blog.bluedot.org/p/2022-ai-alignment-course-impact): 123 alumni (37% of 342) now work full-time on AI safety
...
*Source: [Overview of AI Safety Funding Situation](https://forum.effectivealtruism.org/posts/XdhwXppfqrpPL2YDX/an-overview-of-the-ai-safety-funding-situation)*
...
- [2025 Technical AI Safety RFP](https://www.openphilanthropy.org/request-for-proposals-technical-ai-safety-research/): Expected to spend ~$40M over 5 months
...
**[AI Safety Fund (Frontier Model Forum)](https://www.frontiermodelforum.org/ai-safety-fund/):**
...
**Bottlenecks:**
- **Talent exceeds funding for roles, but not for orgs:** Plenty of aspiring researchers but [not enough organizations to hire them](https://forum.effectivealtruism.org/posts/m5dDrMfHjLtMu293G/ai-safety-s-talent-pipeline-is-over-optimised-for)
- **Grantmaker capacity:** Open Philanthropy [struggled to make qualified senior hires](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/) for technical AI safety grantmaking
...
|-------------|----------------|-------|--------|
| UC Berkeley | [CHAI](https://humancompatible.ai/) (Center for Human-Compatible AI) | Foundational alignment research | Active |
...
- [Open Philanthropy funding university-based safety research](https://www.openphilanthropy.org/grants/?q=ai+safety) including Ohio State
...
- [80,000 Hours technical AI safety upskilling resources](https://80000hours.org/2025/06/technical-ai-safety-upskilling-resources/)
...
*Source: [AI Safety Field Growth Analysis 2025](https://forum.effectivealtruism.org/posts/7YDyziQxkWxbGmF3u/ai-safety-field-growth-analysis-2025)*
...
According to [analysis on the EA Forum](https://forum.effectivealtruism.org/posts/m5dDrMfHjLtMu293G/ai-safety-s-talent-pipeline-is-over-optimised-for), the AI safety talent pipeline is over-optimized for researchers:
...
- [Catalyze's pilot program](https://forum.effectivealtruism.org/posts/q3rpkJGiMwdRvuZza/catalyze-is-hiring-ai-safety-incubation-program-lead-and) incubated 11 organizations, with participants reporting the program accelerated progress by an average of 11 months
...
- [AI Safety Field Growth Analysis 2025](https://forum.effectivealtruism.org/posts/7YDyziQxkWxbGmF3u/ai-safety-field-growth-analysis-2025) — Comprehensive dataset of technical and non-technical AI safety organizations and FTEs
- [AI Safety Field Growth Analysis 2025 (LessWrong)](https://www.lesswrong.com/posts/8QjAnWyuE9fktPRgS/ai-safety-field-growth-analysis-2025) — Cross-post with additional discussion

### Funding
- [An Overview of the AI Safety Funding Situation](https://forum.effectivealtruism.org/posts/XdhwXppfqrpPL2YDX/an-overview-of-the-ai-safety-funding-situation) — Detailed breakdown of philanthropic funding sources
- [Open Philanthropy: Our Progress in 2024 and Plans for 2025](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/) — Self-assessment of AI safety grantmaking
- [Open Philanthropy Technical AI Safety RFP](https://www.openphilanthropy.org/request-for-proposals-technical-ai-safety-research/) — 2025 request for proposals ($40M available)
- [AI Safety and Security Need More Funders](https://coefficientgiving.org/research/ai-safety-and-security-need-more-funders/) — Analysis of funding gaps

### Training Programs
- [MATS Program](https://www.matsprogram.org/) — ML Alignment & Theory Scholars official site
- [MATS Spring 2024 Extension Retrospective](https://www.lesswrong.com/posts/JPfJaXTDQKQQocc2f/mats-spring-2024-extension-retrospective) — Detailed outcomes data
- [ARENA 5.0 Impact Report](https://www.lesswrong.com/posts/XXTanE2GeP5Lchp9G/arena-5-0-impact-report) — Program outcomes and effectiveness
- [ARENA 4.0 Impact Report](https://www.lesswrong.com/posts/5t73TZCf5yE69HbFP/arena-4-0-impact-report-1) — Earlier cohort data
- [BlueDot Impact: 2022 AI Alignment Course Impact](https://blog.bluedot.org/p/2022-ai-alignment-course-impact) — Detailed analysis showing 37% career conversion

### Talent Pipeline
- [AI Safety's Talent Pipeline is Over-optimised for Researchers](https://forum.effectivealtruism.org/posts/m5dDrMfHjLtMu293G/ai-safety-s-talent-pipeline-is-over-optimised-for) — Key critique of current pipeline structure
- [Widening AI Safety's Talent Pipeline](https://forum.effectivealtruism.org/posts/p4ekwamhsw6jpKEcu/widening-ai-safety-s-talent-pipeline-by-meeting-people-where) — Proposals for improvement
- [80,000 Hours: AI Safety Technical Research Career Review](https://80000hours.org/career-reviews/ai-safety-researcher/) — Career guidance
- [80,000 Hours: Updates to Our Research About AI Risk and Careers](https://80000hours.org/2024/08/updates-to-our-research-about-ai-risk-and-careers/) — 2024 strategic updates

### Industry Assessment
- [FLI AI Safety Index 2024](https://futureoflife.org/document/fli-ai-safety-index-2024/) — Assessment of AI company safety practices
- [AI Safety Index Winter 2025](https://futureoflife.org/ai-safety-index-winter-2025/) — Updated industry assessment
- [CAIS 2024 Impact Report](https://safe.ai/work/impact-report/2024) — Center for AI Safety annual report

### International Coordination
- [International AI Safety Report 2025](https://internationalaisafetyreport.org/publication/international-ai-safety-report-2025) — Report by 96 AI experts on global safety landscape
- [The Global Landscape of AI Safety Institutes](https://alltechishuman.org/all-tech-is-human-blog/the-global-landscape-of-ai-safety-institutes) — Overview of government AI safety efforts

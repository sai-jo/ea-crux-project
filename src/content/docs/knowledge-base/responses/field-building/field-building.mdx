...
import { DataInfoBox, EstimateBox, KeyQuestions , PageStatus} from '../../../../../components/wiki';

<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="Field-building focuses on growing the AI safety ecosystem through training programs (ARENA, MATS), public communication, funding ($200M+/year from Open Philanthropy), and community infrastructure. Effectiveness depends critically on whether AI safety is talent-constrained versus idea-constrained and whether field growth maintains quality while scaling." todo="Update program statistics and funding figures for 2025; add more outcome metrics for training program effectiveness" />

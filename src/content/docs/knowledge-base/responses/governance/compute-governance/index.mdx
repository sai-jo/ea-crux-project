...
|------|-----------|---------------|
| [Racing Dynamics](/knowledge-base/risk-factors/racing-dynamics/) | Slows development pace, reduces competitive pressure | High |
| [Proliferation](/knowledge-base/risk-factors/proliferation/) | Restricts access to training compute for new actors | Medium-High |

...
|-----------|------------|----------------------|
| **Tractability** | Medium | 30-50% chance of meaningful regulation by 2027 in major jurisdictions |
| **Resource Allocation** | Growing | ~$200M/year globally on AI governance research and advocacy |
| **Field Size** | ~500-1000 dedicated professionals | Growing 20-30% annually |
| **Political Will** | Increasing | 70%+ of G7 countries have active AI governance initiatives |
| **Estimated X-Risk Reduction** | 5-25% | Highly uncertain; depends on international coordination success |
...
| Intervention Area | Current Evidence | Estimated Effectiveness | Confidence |
|-------------------|------------------|------------------------|------------|
| International coordination | Early stage; summits ongoing | 20-40% x-risk reduction if binding agreements achieved | Low |
| National regulation (EU AI Act) | Implementation beginning 2025 | 15-30% behavioral change in regulated entities | Medium |
| Export controls | Measurable impact on chip access | 1-3 year delay in adversary capabilities | Medium |
| AI Safety Institutes | Staff: UK ~50, US ~100 (planned) | 10-20% improvement in government evaluation capacity | Low-Medium |
| Voluntary commitments | High adoption, weak enforcement | 5-15% risk reduction | Low |

### Resource Requirements

| Intervention | Investment Needed | Timeline | Expected Impact |
|--------------|------------------|----------|-----------------|
| Policy research (GovAI-scale org) | $5-15M/year | Ongoing | 10-20 influential papers/year |
| Government capacity (AISI) | $50-200M/year per country | 2-5 years | Meaningful evaluation capability |
| Advocacy campaigns | $1-5M per campaign | 1-3 years | 5-20% policy influence |
| International coordination (summits) | $5-20M per summit | 6-12 months per cycle | Soft commitments, relationship building |
| Career development (fellowships) | $100K-300K per fellow | 2-year programs | 50-100 new governance professionals/year |

### Key Uncertainties

| Uncertainty | Range of Estimates | Impact on Strategy |
|-------------|-------------------|-------------------|
| Time until transformative AI | 3-30 years | Determines urgency; shorter timelines favor emergency measures |
| US-China cooperation probability | 10-40% | Critical for global coordination; low probability favors unilateral action |
| Regulatory capture risk | 30-60% of policies affected | Need independent oversight and civil society engagement |
| Technical feasibility of verification | 40-70% achievable with current methods | Affects enforceability of compute governance |
| Political durability | 50-80% survival past next election cycle | Favor embedding in institutions over executive action |

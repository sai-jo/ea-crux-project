...
The algorithm registration database maintained by CAC has become a central mechanism for monitoring and controlling AI systems in China. As of 2024, over 3,000 algorithms have been registered, including recommendation systems from major platforms like ByteDance (TikTok/Douyin), Alibaba, Tencent, and Baidu. The registration process requires detailed technical documentation, security assessments, and ongoing compliance monitoring.
...
Despite bilateral tensions, China continues to participate in multilateral AI governance forums, including the OECD AI Principles (as a signatory), United Nations discussions on AI governance, and various technical standards organizations. However, Chinese engagement has focused on promoting principles of national sovereignty over AI development and resisting binding international constraints that might limit national AI strategies.
...
However, Chinese regulations show limited public engagement with catastrophic AI risks or existential threats from advanced AI systems. Unlike the United States and United Kingdom, which have established dedicated AI Safety Institutes focused on frontier AI risks, China has not created comparable public institutions or research programs specifically addressing scenarios where AI systems could pose civilization-level threats. This gap may reflect different risk assessment priorities, classified internal research efforts, or skepticism about advanced AI timelines.
...
Over the next 1-2 years, Chinese AI regulations are expected to expand into additional sectors including autonomous vehicles, medical AI applications, and financial algorithmic trading systems. The regulatory framework will likely become more comprehensive while maintaining the emphasis on pre-deployment approval and content alignment requirements. Enforcement capabilities are expected to strengthen through improved technical monitoring systems and increased regulatory personnel.

...
<PageStatus quality={3} lastEdited="2025-12-24" llmSummary="AI Control is a research agenda focused on maintaining safety even when using AI systems that might be actively trying to subvert safety measures, using techniques like monitoring, containment, redundancy, and red-teaming rather than assuming alignment succeeds." todo="Add specific examples of control protocols, cite key Redwood Research papers, expand limitations section with concrete scenarios where control fails" />

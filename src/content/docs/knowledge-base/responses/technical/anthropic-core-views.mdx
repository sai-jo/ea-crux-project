...
<PageStatus quality={3} lastEdited="2025-12-24" llmSummary="Anthropic's Core Views articulate their belief that transformative AI is coming soon and that safety-focused organizations need to be at the frontier to conduct meaningful alignment research, covering their research priorities in Constitutional AI, mechanistic interpretability, scalable oversight, and responsible scaling." todo="Add publication date and link to original Core Views document, include more specific critiques with sources, expand on how their views have evolved since publication" />

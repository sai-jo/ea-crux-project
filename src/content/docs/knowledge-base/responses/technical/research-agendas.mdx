...
import { ComparisonTable, DataInfoBox, DisagreementMap, KeyQuestions , PageStatus} from '../../../../../components/wiki';

<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="Comprehensive comparison of major AI safety research agendas including Anthropic's Constitutional AI and Interpretability, DeepMind's Scalable Oversight, ARC's ELK, Redwood's AI Control, and MIRI's Agent Foundations, analyzing their assumptions, strengths, criticisms, and key disagreements about which approaches will succeed." todo="Update OpenAI Superalignment status (team dissolved in 2024), add more recent publications from 2024-2025, include newer research organizations that have emerged" />

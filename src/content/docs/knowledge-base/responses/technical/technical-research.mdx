...
<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="Technical AI safety research aims to make AI systems reliably safe through scientific and engineering work across six major agendas: mechanistic interpretability, scalable oversight, robustness and adversarial techniques, agent foundations, AI control, and evaluations, with detailed coverage of approaches, organizations, career paths, and tractability assessments for each area." todo="Update OpenAI Superalignment team status (dissolved), add 2024-2025 developments in interpretability and evaluations, update compensation ranges and organization sizes for accuracy" />

...
<PageStatus quality={3} lastEdited="2025-12-24" llmSummary="Analyzes how humans over-trust AI systems and accept outputs without proper verification, leading to errors propagating, skills degrading, and accountability diffusing, with practical examples from medicine, coding, and navigation." todo="Add specific empirical data on automation bias rates; include more case studies of errors from automation bias; expand mitigation strategies with concrete implementation examples" />

...
<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="Detailed examination of how AI enables manufacturing fake public opinion through bots, fake reviews, and comment flooding, with extensive documentation of attack vectors, current evidence from FCC net neutrality case, and why detection is failing." todo="Fix truncated summary text in line 11; add more 2025 examples of consensus manufacturing" />
...
**Mechanism:**
1. AI generates fake academic papers (see [Scientific Knowledge Corruption](/knowledge-base/risk-factors/scientific-corruption/))

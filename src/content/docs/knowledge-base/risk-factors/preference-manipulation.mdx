...
<PageStatus quality={4} lastEdited="2025-12-24" llmSummary="Comprehensive examination of how AI shapes human desires through recommendation systems, personalized advertising, and conversational AI, documenting the five-stage mechanism from profiling to preference lock-in, with extensive coverage of current systems and future escalation paths." todo="Add more recent research on preference manipulation effectiveness; expand on regulatory approaches beyond EU/California; include neuroscience evidence on preference formation" />

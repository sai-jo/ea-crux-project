...
import {DataInfoBox, DisagreementMap, KeyQuestions, Backlinks, EstimateBox} from '../../../../components/wiki';
...
**Key proponents:**
- *Convergent:* Eliezer Yudkowsky argues deception follows from instrumental convergence ([AGI Ruin](https://www.lesswrong.com/posts/uMQ3cqWDPHhjtiesc/agi-ruin-a-list-of-lethalities)); Evan Hubinger's [Risks from Learned Optimization](https://arxiv.org/abs/1906.01820) formalizes how mesa-optimizers could develop deceptive objectives
- *Unlikely:* Paul Christiano has argued gradient descent may select against complex deceptive cognition; Quintin Pope contends that [sycophancy is more likely than scheming](https://www.lesswrong.com/posts/qmxodHBcAHNGF5bPv/the-sycophancy-trap-why-alignment-is-harder-than-deception)
...
**Key proponents:**
- *Detectable:* Chris Olah's interpretability research program at Anthropic aims to make neural networks transparent enough to detect deceptive cognition; Redwood Research's work on [eliciting latent knowledge](https://docs.google.com/document/d/1WwsnJQstPq91_Yh-Ch2XRL8H_EpsnjrC1dwZXR37PC8/edit) addresses related detection challenges
- *Undetectable:* Anthropic's [Sleeper Agents](https://arxiv.org/abs/2401.05566) paper shows backdoored behaviors can persist through safety training; the paper found that "behavioral training techniques" may even create a "false sense of security"
...
- *Human-level sufficient:* Owain Evans and collaborators have studied [situational awareness](https://arxiv.org/abs/2309.00667) in current models and found early signs of self-awareness; roleplay and persona maintenance in current LLMs suggests deception-adjacent capabilities already exist

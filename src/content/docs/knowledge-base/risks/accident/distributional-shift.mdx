...
<PageStatus quality={3} lastEdited="2025-12-23" llmSummary="Distributional shift occurs when AI systems encounter inputs or situations that differ from their training distribution, leading to degraded or unpredictable performance—one of the most common and well-documented sources of AI failure in deployed systems." todo="Add specific real-world case studies and quantitative research on shift detection methods" />

...
<InfoBox
  ...
  title="Instrumental Convergence"
  severity="high"
  likelihood="High (theoretical)"
  timeframe="Advanced AI"
  customFields={[
    { label: "First Described", value: "Omohundro 2008" },
    { label: "Formalized", value: "Bostrom 2014" },
  ]}
/>
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      description="Formal analysis of resource acquisition drives"
    />
    <EntityCard
      id="corrigibility"
    ...
    <EntityCard
      ...
      category="lab"
      title="MIRI"
      description="Developed much of the theory around convergent goals"
    />
  </EntityCards>
</Section>

<Sources sources={[
  { title: "The Basic AI Drives", url: "https://selfawaresystems.files.wordpress.com/2008/01/ai_drives_final.pdf", author: "Steve Omohundro", date: "2008" },
  { title: "Superintelligence, Chapter 7", author: "Nick Bostrom", date: "2014" },
  { title: "Optimal Policies Tend to Seek Power", url: "https://arxiv.org/abs/2206.13477", author: "Turner et al." },
]} />

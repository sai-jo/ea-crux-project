...
> **For comprehensive analysis**, see [Preference Authenticity](/knowledge-base/parameters/preference-authenticity/), which covers:
...
See [Preference Authenticity](/knowledge-base/parameters/preference-authenticity/) for detailed intervention analysis.
...
### Primary Reference
- **[Preference Authenticity](/knowledge-base/parameters/preference-authenticity/)** — Comprehensive parameter page with mechanisms, measurement, and interventions

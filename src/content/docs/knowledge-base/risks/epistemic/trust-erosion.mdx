...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      description="Ultimate consequence of trust erosion"
    />
    <EntityCard
      id="disinformation"
      category="risk"
      title="Disinformation"
      description="AI-powered attacks on trust"
    />
    <EntityCard
      id="deepfakes"
      category="risk"
      title="Deepfakes"
      description="Fabricated evidence undermining trust"
    />
  </EntityCards>
</Section>

<Sources sources={[
  { title: "Trust: The Social Virtues and the Creation of Prosperity", author: "Francis Fukuyama" },

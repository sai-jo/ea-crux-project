...
<PageStatus quality={4} lastEdited="2025-12-23" llmSummary="Examines how AI could accelerate biological weapons development by lowering barriers to pathogen design and synthesis, featuring key studies like the RAND red-team evaluation showing minimal current uplift and Microsoft's findings on DNA screening gaps, alongside debates on whether marginal capabilities matter." todo="Include more biosecurity expert perspectives; add section on gain-of-function research governance" />

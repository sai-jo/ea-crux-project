...
<PageStatus quality={4} lastEdited="2025-12-23" llmSummary="Documents the dramatic rise of AI-powered fraud including voice cloning and deepfake video scams, with FBI reporting $16.6B in losses (33% increase from 2023), featuring detailed case studies from the $25M Arup meeting fraud to multiple thwarted CEO impersonation attempts that highlight both the threat and effective defenses." todo="Add economic analysis of fraud industry; expand section on authentication methods that remain trustworthy in AI era" />

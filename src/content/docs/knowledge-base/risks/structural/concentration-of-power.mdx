...
> **For comprehensive analysis**, see [AI Control Concentration](/knowledge-base/ai-transition-model/factors/misuse-potential/ai-control-concentration/), which covers:
...
See [AI Control Concentration](/knowledge-base/ai-transition-model/factors/misuse-potential/ai-control-concentration/) for detailed analysis.
...
### Primary Reference
- **[AI Control Concentration](/knowledge-base/ai-transition-model/factors/misuse-potential/ai-control-concentration/)** — Comprehensive parameter page with mechanisms, measurement, and interventions
...
### Related Parameters
- [Regulatory Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/regulatory-capacity/) — Government ability to constrain concentration
- [Coordination Capacity](/knowledge-base/ai-transition-model/factors/civilizational-competence/coordination-capacity/) — Multi-actor cooperation on governance
- [Institutional Quality](/knowledge-base/ai-transition-model/factors/civilizational-competence/institutional-quality/) — Checks and balances strength

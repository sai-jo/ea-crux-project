...
<PageStatus quality={4} lastEdited="2025-12-23" llmSummary="AI enables unprecedented power concentration in small groups (companies, states, individuals) through capability requirements (massive compute, rare talent, proprietary data) that only a few entities can assemble, creating winner-take-all dynamics across economic, political, military, and information domains simultaneously." todo="Add quantitative data on current compute concentration; expand international governance section; include more on potential positive scenarios" />

...
> **For comprehensive analysis**, see [Economic Stability](/knowledge-base/parameters/economic-stability/), which covers:
...
See [Economic Stability](/knowledge-base/parameters/economic-stability/) for detailed analysis.
...
### Primary Reference
- **[Economic Stability](/knowledge-base/parameters/economic-stability/)** — Comprehensive parameter page with current state, threats, supports, and scenarios
...
### Related Parameters
- [Human Expertise](/knowledge-base/parameters/human-expertise/) — Skills at risk of atrophy
- [Societal Trust](/knowledge-base/parameters/societal-trust/) — Economic disruption erodes trust

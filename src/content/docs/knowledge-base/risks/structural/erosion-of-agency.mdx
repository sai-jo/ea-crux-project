...
<PageStatus quality={3} lastEdited="2025-12-23" llmSummary="Humans lose meaningful control over life choices as AI systems increasingly mediate, predict, and direct behavior through algorithmic curation, behavioral prediction, and automated decisions, creating information asymmetry and manipulation potential even while people retain formal capability to choose." todo="Distinguish more clearly from enfeeblement throughout; add quantitative research on manipulation effectiveness; expand regulatory response section with specific policy proposals" />

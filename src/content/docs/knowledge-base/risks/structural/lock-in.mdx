...
<PageStatus quality={4} lastEdited="2025-12-23" llmSummary="AI could enable permanent entrenchment of values, political systems, technologies, or economic structures through enforcement tools (surveillance, predictive control), rapid scale making early decisions irreversible, and complex path dependencies that make course correction prohibitively expensive or impossible." todo="Add more concrete scenarios for value lock-in; expand on critical decision points we currently face; include framework for evaluating which choices risk lock-in" />
